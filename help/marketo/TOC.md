...
+ [Startsida](home.md)
+ Komma igång med Marketo Engage {#getting-started}
   + [Vad är Adobe Marketo Engage?](getting-started/what-is-adobe-marketo-engage.md)
   + Inledande konfiguration {#initial-setup}
      + [Installationssteg](getting-started/initial-setup/setup-steps.md)
      + [Konfigurera protokoll](getting-started/initial-setup/configure-protocols-for-marketo.md)
      + [Användarinställningar](getting-started/initial-setup/user-setup.md)
   + Implementera en ny Marketo Engage-instans {#implementing-a-new-marketo-engage-instance}
      + [Var ska man börja?](getting-started/implementing-a-new-marketo-engage-instance/where-to-start.md)
      + [Metodtips för nya instanser: Checklista för administratörsavsnitt](getting-started/implementing-a-new-marketo-engage-instance/admin-section-checklist.md)
      + [Metodtips för nya instanser: Checklista för databaser](getting-started/implementing-a-new-marketo-engage-instance/database-checklist.md)
      + [Metodtips för nya instanser: Checklista för Design Studio](getting-started/implementing-a-new-marketo-engage-instance/design-studio-checklist.md)
      + [Bästa praxis för nya instanser: Checklista för marknadsföringsaktiviteter](getting-started/implementing-a-new-marketo-engage-instance/marketing-activities-checklist.md)
      + [Ny instansmetodpraxis: Analyschecklista](getting-started/implementing-a-new-marketo-engage-instance/analytics-checklist.md)
      + [Bästa praxis för nya instanser: Dokumentera din konfiguration](getting-started/implementing-a-new-marketo-engage-instance/document-your-setup.md)
   + Saker att veta {#things-to-know}
      + [Marketo Engage ordlista](getting-started/things-to-know/marketo-engage-glossary.md)
      + [Ikon Ordlista](getting-started/things-to-know/icon-glossary.md)
      ...
      + [Gemenskap för Marketing Nation](getting-started/things-to-know/community.md)
   + Snabbvinningar {#quick-wins}
      ...
      + [Autosvar via e-post](getting-started/quick-wins/email-auto-response.md)
      + [Importera en lista med personer](getting-started/quick-wins/import-a-list-of-people.md)
      + [Droppa, droppa, vårda](getting-started/quick-wins/drip-drip-nurture.md)
...
+ Produktdokument {#product-docs}
   ...
   + Administrering {#administration}
      ...
      + Användare och roller {#users-and-roles}
         + [Skapa en användarroll med endast API](product-docs/administration/users-and-roles/create-an-api-only-user-role.md)
         + [Skapa en användare med endast API](product-docs/administration/users-and-roles/create-an-api-only-user.md)
         ...
         + [Verifiering av e-post](product-docs/administration/users-and-roles/email-verification.md)
         + [Exportera en lista över användare och roller](product-docs/administration/users-and-roles/export-a-list-of-users-and-roles.md)
         ...
         + [Aktivera No-Draft för Snippets](product-docs/administration/users-and-roles/enable-no-draft-for-snippets.md)
   ...
   + Adobe Experience Cloud Integrations {#adobe-experience-cloud-integrations}
      ...
      + [Konfigurera Adobe organisationsmappning](product-docs/adobe-experience-cloud-integrations/set-up-adobe-organization-mapping.md)
   ...
   + Marketo Core Concepts {#core-marketo-concepts}
      + Smarta kampanjer {#smart-campaigns}
         ...
         + Flödesåtgärder {#flow-actions}
            ...
            + [Rensa fältvärden](product-docs/core-marketo-concepts/smart-campaigns/flow-actions/clear-field-values.md)
   ...
   + CRM-synkronisering {#crm-sync}
      + Microsoft Dynamics Sync {#microsoft-dynamics}
         ...
         + Synkronisera inställningar {#sync-setup}
            ...
            + Microsoft Dynamics 365 med S2S-anslutning{#microsoft-dynamics-365-with-s2s-connection}
               ...
               + [Steg 3 av 3: Anslut Marketo Solution med S2S-anslutning](product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-s2s-connection/step-3-of-3-connect.md)
      ...
      + Veeva CRM Sync {#veeva-crm-sync}
         ...
         + Inställningar {#setup}
            ...
            + [Steg 3 av 3: Anslut Marketo Engage och Veeva CRM](product-docs/crm-sync/veeva-crm-sync/setup/step-3-of-3-connect-marketo-engage-and-veeva-crm.md)
   ...
   + Skapa efterfrågan {#demand-generation}
      + Annonsnätverksintegrering {#ad-network-integrations}
         ...
         + [Skicka en lista till Google](product-docs/demand-generation/ad-network-integrations/send-a-list-to-google.md)
      + Dynamic Chat {#dynamic-chat}
         + [Dynamic Chat - översikt](product-docs/demand-generation/dynamic-chat/dynamic-chat-overview.md)
         + [Chatbot-beteende](product-docs/demand-generation/dynamic-chat/chatbot-behavior.md)
         + [Lista över möten](product-docs/demand-generation/dynamic-chat/meeting-list.md)
         ...
         + Installation och konfiguration {#setup-and-configuration}
            ...
            + [Hantering av agenter](product-docs/demand-generation/dynamic-chat/setup-and-configuration/agent-management.md)
            + [Säkerhetsinställningar](product-docs/demand-generation/dynamic-chat/setup-and-configuration/security-settings.md)
         ...
         + Livechatt {#live-chat}
            + [Översikt över livechatt](product-docs/demand-generation/dynamic-chat/live-chat/live-chat-overview.md)
            + [Inkorg för handläggare](product-docs/demand-generation/dynamic-chat/live-chat/agent-inbox.md)
            + [Meddelanden](product-docs/demand-generation/dynamic-chat/live-chat/notifications.md)
         + Generativ AI {#generative-ai}
            + [Översikt över generativ AI](product-docs/demand-generation/dynamic-chat/generative-ai/overview.md)
            + [Generering av frågor](product-docs/demand-generation/dynamic-chat/generative-ai/question-generation.md)
            + [Bibliotek för svar](product-docs/demand-generation/dynamic-chat/generative-ai/response-library.md)
      ...
      + Evenemang {#events}
         + Förstå händelser {#understanding-events}
            + [Lägga till medlemmar i ett evenemangsprogram](product-docs/demand-generation/events/understanding-events/adding-members-to-an-event-program.md)
            ...
            + [Sätta upp mål för evenemanget](product-docs/demand-generation/events/understanding-events/setting-event-goals.md)
         + Skapa en händelse {#create-an-event}
            + [Skapa en händelse med Adobe Connect](product-docs/demand-generation/events/create-an-event/create-an-event-with-adobe-connect.md)
            + [Skapa ett evenemang med GotoWebinar](product-docs/demand-generation/events/create-an-event/create-an-event-with-gotowebinar.md)
         ...
         + Interaktiva webbinarier {#interactive-webinars}
            ...
            + [Kom igång med interaktiva webbinarier](product-docs/demand-generation/events/interactive-webinars/get-started-with-interactive-webinars.md)
            ...
            + [Testa ett interaktivt webbinarium](product-docs/demand-generation/events/interactive-webinars/testing-an-interactive-webinar.md)
      ...
      + Forms {#forms}
         ...
         + Använda CAPTCHA {#using-captcha}
            ...
            + [Aktivera CAPTCHA i Marketo Forms](product-docs/demand-generation/forms/using-captcha/enable-captcha-in-marketo-forms.md)
      + Bilder och filer {#images-and-files}
         ...
         + [Bildredigeraren](product-docs/demand-generation/images-and-files/image-editor.md)
      ...
      + Landningssidor {#landing-pages}
         ...
         + Landningssidor i fri form {#free-form-landing-pages}
            ...
            + [Lägga till anpassad HTML på en landningssida med kostnadsfri form](product-docs/demand-generation/landing-pages/free-form-landing-pages/adding-custom-html-to-a-free-form-landing-page.md)
         ...
         + Åtgärder för landningssida {#landing-page-actions}
            ...
            + [Dirigera om en Marketo-landningssida till en annan sida](product-docs/demand-generation/landing-pages/landing-page-actions/redirect-a-marketo-landing-page-to-another-page.md)
         + Mallar för landningssidor {#landing-page-templates}
            ...
            + [Redigera en Marketo-mall för landningssidor](product-docs/demand-generation/landing-pages/landing-page-templates/edit-a-marketo-landing-page-template.md)
            ...
            + [Lista med guidade landningssidmallar](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-template-list.md)
            + Guided Landing Page Templates {#guided-landing-page-templates}
               + [Mall 1A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1a.md)
               + [Mall 1B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1b.md)
               + [Mall 1C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1c.md)
               + [Mall 1D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1d.md)
               + [Mall 1E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1e.md)
               + [Mall 1F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-1f.md)
               + [Mall 2A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2a.md)
               + [Mall 2B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2b.md)
               + [Mall 2C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2c.md)
               + [Mall 2D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-2d.md)
               + [Mall 3A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3a.md)
               + [Mall 3B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3b.md)
               + [Mall 3C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3c.md)
               + [Mall 3D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-3d.md)
               + [Mall 4A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-4a.md)
               + [Mall 4B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-4b.md)
               + [Mall 4C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-4c.md)
               + [Mall 5A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5a.md)
               + [Mall 5B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5b.md)
               + [Mall 5C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5c.md)
               + [Mall 5D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5d.md)
               + [Mall 5E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-5e.md)
               + [Mall 6A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6a.md)
               + [Mall 6B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6b.md)
               + [Mall 6C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6c.md)
               + [Mall 6D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6d.md)
               + [Mall 6E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-6e.md)
               + [Mall 7A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7a.md)
               + [Mall 7B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-7b.md)
               ...
               + [Mall 8D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-8d.md)
               ...
               + [Mall 9E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9e.md)
               + [Mall 9F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-9f.md)
               + [Mall 10A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10a.md)
               + [Mall 10B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10b.md)
               + [Mall 10C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10c.md)
               + [Mall 10D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10d.md)
               + [Mall 10E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10e.md)
               + [Mall 10F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-10f.md)
               + [Mall 11A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11a.md)
               + [Mall 11B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11b.md)
               + [Mall 11C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11c.md)
               + [Mall 11D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11d.md)
               + [Mall 11E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11e.md)
               + [Mall 11F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-11f.md)
               + [Mall 12A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12a.md)
               + [Mall 12B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12b.md)
               + [Mall 12C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12c.md)
               + [Mall 12D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12d.md)
               + [Mall 12E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12e.md)
               + [Mall 12F](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-12f.md)
               + [Mall 13A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13a.md)
               + [Mall 13B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13b.md)
               + [Mall 13C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13c.md)
               + [Mall 13D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13d.md)
               + [Mall 13E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-13e.md)
               + [Mall 14A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14a.md)
               + [Mall 14B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14b.md)
               + [Mall 14C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14c.md)
               + [Mall 14D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14d.md)
               + [Mall 14E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-14e.md)
               + [Mall 15A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15a.md)
               + [Mall 15B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15b.md)
               + [Mall 15C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15c.md)
               + [Mall 15D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15d.md)
               + [Mall 15E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-15e.md)
               + [Mall 16A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16a.md)
               + [Mall 16B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16b.md)
               + [Mall 16C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16c.md)
               + [Mall 16D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16d.md)
               + [Mall 16E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-16e.md)
               + [Mall 17A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17a.md)
               + [Mall 17B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17b.md)
               + [Mall 17C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17c.md)
               + [Mall 17D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17d.md)
               + [Mall 17E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-17e.md)
               + [Mall 18A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18a.md)
               + [Mall 18B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18b.md)
               + [Mall 18C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18c.md)
               + [Mall 18D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18d.md)
               + [Mall 18E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-18e.md)
               + [Mall 19A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19a.md)
               + [Mall 19B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19b.md)
               + [Mall 19C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19c.md)
               + [Mall 19D](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19d.md)
               + [Mall 19E](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-19e.md)
               + [Mall 20A](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20a.md)
               + [Mall 20B](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20b.md)
               + [Mall 20C](product-docs/demand-generation/landing-pages/landing-page-templates/guided-landing-page-templates/template-20c.md)
         ...
         + Anpassa landningssidor {#personalizing-landing-pages}
            ...
            + [Lägg till SSL TEMP DOC](product-docs/demand-generation/landing-pages/personalizing-landing-pages/add-ssl-temp-doc.md)
      ...
      + Social {#social}
         + Konfigurera sociala åtgärder {#configuring-social-actions}
            ...
            + [Konfigurera PERSON Capture för en social app](product-docs/demand-generation/social/configuring-social-actions/configure-person-capture-for-a-social-app.md)
         ...
         + Sociala funktioner {#social-functions}
            ...
            + [Använd en Marketo-lista eller smart lista som ett LinkedIn-målsegment](product-docs/demand-generation/social/social-functions/use-a-marketo-list-or-smart-list-as-a-linkedin-audience-segment.md)
   ...
   + E-postmarknadsföring {#email-marketing}
      + Levererbarhetsstrategi {#deliverability}
         ...
         + Inkorgsspåraren {#inbox-tracker}
            + [Självstudiekurser för Inkorgsspåraren](product-docs/email-marketing/deliverability/inbox-tracker/inbox-tracker-tutorials.md)
      + Drivrutiner {#drip-nurturing}
         ...
         + Använda direktuppspelat innehåll {#using-stream-content}
            ...
            + [Prioritera direktuppspelat innehåll](product-docs/email-marketing/drip-nurturing/using-stream-content/prioritize-stream-content.md)
      ...
      + E-posta Designer {#email-designer}
         ...
         + [Anpassningsbara fragment](product-docs/email-marketing/email-designer/customizable-fragments.md)
      ...
      + E-postprogram {#email-programs}
         ...
         + E-postprogramdata {#email-program-data}
            ...
            + [Visa instrumentpanelen för e-postprogrammet](product-docs/email-marketing/email-programs/email-program-data/view-the-email-program-dashboard.md)
         + Hantera personer i e-postprogram {#managing-people-in-email-programs}
            + [Definiera en målgrupp genom att importera en lista](product-docs/email-marketing/email-programs/managing-people-in-email-programs/define-an-audience-by-importing-a-list.md)
            + [Definiera en målgrupp med en smart lista](product-docs/email-marketing/email-programs/managing-people-in-email-programs/define-an-audience-with-a-smart-list.md)
            + [Importera en lista med icke-latinska tecken](product-docs/email-marketing/email-programs/managing-people-in-email-programs/import-a-non-latin-characters-list.md)
      + Allmänt {#general}
         + Förstå e-postredigeraren {#understanding-the-email-editor}
            + [Förstå loggning av e-posthändelser](product-docs/email-marketing/general/understanding-the-email-editor/understanding-email-event-logging.md)
         ...
         + Beta Ny e-postdesigner {#beta-new-email-designer}
            + [Översikt över ny e-postdesigner (beta)](product-docs/email-marketing/general/beta-new-email-designer/overview.md)
            + [Redigering av e-post](product-docs/email-marketing/general/beta-new-email-designer/email-authoring.md)
            + [E-postmallar](product-docs/email-marketing/general/beta-new-email-designer/email-templates.md)
         + Skapa ett e-postmeddelande {#creating-an-email}
            ...
            + [Skicka ett exempel på ett e-postmeddelande](product-docs/email-marketing/general/creating-an-email/send-a-sample-email.md)
         ...
         + Funktioner i Redigeraren {#functions-in-the-editor}
            ...
            + [Ladda ned en HTML för e-post](product-docs/email-marketing/general/functions-in-the-editor/download-an-emails-html.md)
            + [Redigera en e-posts HTML](product-docs/email-marketing/general/functions-in-the-editor/edit-an-emails-html.md)
            + E-posttester - Champion-Challenger {#email-tests-champion-challenger}
               ...
               + [Champion/Challenger: Deklarera en mästare](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-declare-a-champion.md)
               + [Champion/Challenger: Definiera tävlingskriterier](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-define-champion-criteria.md)
               ...
               + [Befälhavare/kanal: Från adress](product-docs/email-marketing/general/functions-in-the-editor/email-tests-champion-challenger/champion-challenger-from-address.md)
   ...
   + Marketo Notifications {#marketo-notifications}
      + [Meddelande: Webbsocketanslutning](product-docs/marketo-notifications/websocket-connection.md)
   + Marketo Sales Connect {#marketo-sales-connect}
      ...
      + E-postplugin-program {#email-plugins}
         + Gmail {#gmail}
            ...
            + [Bifoga en innehållskomponent](product-docs/marketo-sales-connect/email-plugins/gmail/attaching-a-piece-of-content.md)
      ...
      + E-post {#email}
         + Kommandocentral {#command-center}
            ...
            + [Snabba upp arbetsflödet med hjälp av snabbåtgärder](product-docs/marketo-sales-connect/email/command-center/using-quick-actions-to-speed-up-your-workflow.md)
         ...
         + Avbeställ {#unsubscribes}
            + [Lägg till inställningen för att avbryta prenumerationen](product-docs/marketo-sales-connect/email/unsubscribes/auto-append-unsubscribe-message-setting.md)
      ...
      + Vanliga frågor och svar {#faq}
         ...
         + [Jag har blivit utelåst från mitt konto. Vad ska jag göra?](product-docs/marketo-sales-connect/faq/i-got-locked-out-of-my-account-what-do-i-do.md)
         + [Är Sales Connect kompatibel med Salesforce Lightning?](product-docs/marketo-sales-connect/faq/is-sales-connect-compatible-with-salesforce-lightning.md)
         + [Vilka är användarvillkoren för Sales Connect?](product-docs/marketo-sales-connect/faq/what-are-the-sales-connect-terms-of-service.md)
         ...
         + [Vilka webbläsare och e-postklienter stöds med Sales Connect?](product-docs/marketo-sales-connect/faq/which-browsers-and-email-clients-are-supported-with-sales-connect.md)
      ...
      + Integreringar {#integrations}
         + [Hur man loggar e-postmeddelanden till andra CRM:er](product-docs/marketo-sales-connect/integrations/how-to-log-emails-to-other-crms.md)
      + Marketo {#marketo}
      ...
      + Folk {#people}
         ...
         + Hantera kontakter {#managing-contacts}
            ...
            + [Hur Sales Connect hanterar e-postborttagning av dubbletter](product-docs/marketo-sales-connect/people/managing-contacts/how-sales-connect-handles-email-de-duping.md)
      ...
      + Tel. {#phone}
         ...
         + [Loggade inte in på Aktivitetshistorik](product-docs/marketo-sales-connect/phone/didnt-log-to-activity-history.md)
         + [Loggade inte in på Salesforce](product-docs/marketo-sales-connect/phone/didnt-log-to-salesforce.md)
         ...
         + [Försäljning Telefon Internationella samtal](product-docs/marketo-sales-connect/phone/sales-phone-international-calling.md)
         + [Lokal närvaro för försäljningstelefon](product-docs/marketo-sales-connect/phone/sales-phone-local-presence.md)
   ...
   + Marketo Sales Insight {#marketo-sales-insight}
      + Åtgärder {#actions}
         ...
         + Administratör {#admin}
            ...
            + [Skapa ett team](product-docs/marketo-sales-insight/actions/admin/creating-a-team.md)
         ...
         + Analytics  {#analytics}
            ...
            + [Fliken Innehåll](product-docs/marketo-sales-insight/actions/analytics/understanding-the-content-tab.md)
            + [Fliken Me](product-docs/marketo-sales-insight/actions/analytics/understanding-the-me-tab.md)
            + [Förstå teamfliken](product-docs/marketo-sales-insight/actions/analytics/understanding-the-team-tab.md)
         ...
         + Kampanjer {#campaigns}
            ...
            + [Om sändningsalternativ för försäljningskampanj för e-poststeg](product-docs/marketo-sales-insight/actions/campaigns/understanding-sales-campaign-send-options-for-email-steps.md)
         ...
         + E-postintegreringar {#email-integrations}
            + Gmail {#gmail}
         ...
         + Marketo {#marketo}
            ...
            + [Gör en kampanj synlig för användare av Sales Connect](product-docs/marketo-sales-insight/actions/marketo/make-a-marketing-campaign-visible-in-sales-insight-actions.md)
      ...
      + MSI för Microsoft Dynamics {#msi-for-microsoft-dynamics}
         + Funktioner {#features}
            + [Översikt över funktioner](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/features/feature-overview.md)
            + Marketo Tab {#marketo-tab}
               + [Konfigurera MSI-vyer](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/features/marketo-tab/setting-up-msi-views.md)
               + [Bästa val](product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/features/marketo-tab/best-bets.md)
      ...
      + MSI för Salesforce {#msi-for-salesforce}
         ...
         + Konfiguration {#configuration}
            ...
            + [Lägg till åtkomst till profiler för Sales Insight](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/add-sales-insight-access-to-profiles.md)
            + [Lägg till gruppåtgärdsknappar i Salesforce Classic](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/add-bulk-action-buttons-to-salesforce-classic.md)
            + [Massåtgärder i Salesforce Lightning](product-docs/marketo-sales-insight/msi-for-salesforce/configuration/bulk-actions-in-salesforce-lightning.md)
         + Funktioner {#features}
            ...
            + Flikar på MSI-panelen {#tabs-in-the-msi-panel}
               ...
               + Intressanta ögonblick {#interesting-moments}
                  ...
                  + [Utlösartoken för intressanta ögonblick](product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments/trigger-tokens-for-interesting-moments.md)
      ...
      + MSI Outlook-plugin {#msi-outlook-plugin}
         ...
         + [Installera Marketo e-posttillägg för Outlook med en registreringskod](product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
         + [Utfärda en Marketo e-posttilläggslicens](product-docs/marketo-sales-insight/msi-outlook-plugin/issue-a-marketo-email-add-in-license.md)
         + [Installation av Marketo Outlook-plugin via IT](product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-installation-by-it.md)
         + [Avinstallera Marketo Outlook-plugin med IT](product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-uninstall-by-it.md)
   ...
   + Mobilmarknadsföring {#mobile-marketing}
      ...
      + Meddelanden i appen {#in-app-messages}
         ...
         + Skapa meddelanden i appen {#creating-in-app-messages}
            ...
            + [Konfigurera meddelandebakgrunden i appen](product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/set-up-the-in-app-message-background.md)
   ...
   + Personalisering {#personalization}
      + Segmentering och kodavsnitt {#segmentation-and-snippets}
         + Segmentering {#segmentation}
            ...
            + [Använda segmentfilter i en smart lista](product-docs/personalization/segmentation-and-snippets/segmentation/use-segment-filters-in-a-smart-list.md)
         + Fragment {#snippets}
   ...
   + Rapportering {#reporting}
      ...
      + Grundläggande rapportering {#basic-reporting}
         ...
         + Rapportaktivitet {#report-activity}
            ...
            + [Dela en modell mellan arbetsytor](product-docs/reporting/basic-reporting/report-activity/share-a-model-across-workspaces.md)
      ...
      + Insikter om e-post {#email-insights}
         ...
         + [Översikt över e-postinsikter Analys](product-docs/reporting/email-insights/email-insights-analytics-overview.md)
         + [Vanliga frågor och svar om e-postinsikter](product-docs/reporting/email-insights/email-insights-faq.md)
         + [Snabbdiagram för e-postinsikter](product-docs/reporting/email-insights/email-insights-quick-charts.md)
         + [Översikt över e-postinsikter](product-docs/reporting/email-insights/email-insights-sends-overview.md)
         + [Filtrering i e-postinsikter](product-docs/reporting/email-insights/filtering-in-email-insights.md)
      + Insikter om prestanda {#performance-insights}
         + [Översikt över Performance Insights](product-docs/reporting/performance-insights/performance-insights-overview.md)
         + [Filtrering i Performance Insights](product-docs/reporting/performance-insights/filtering-in-performance-insights.md)
         + [Översikt över bidrag för Performance Insights](product-docs/reporting/performance-insights/performance-insights-contribution-overview.md)
         ...
         + [Ställa in Performance Insights](product-docs/reporting/performance-insights/setting-up-performance-insights.md)
      + Analys av intäktscykeln {#revenue-cycle-analytics}
         + Analys av e-post {#email-analysis}
         ...
         + Analys av påverkan på affärsmöjlighet {#opportunity-influence-analyzer}
            + [Förstå analysen av säljprojektspåverkan](product-docs/reporting/revenue-cycle-analytics/opportunity-influence-analyzer/understanding-the-opportunity-influence-analyzer.md)
         ...
         + Intäktscykelmodeller {#revenue-cycle-models}
            ...
            + [Skapa en ny inkomstmodell](product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/create-a-new-revenue-model.md)
         ...
         + Avancerad BI-analys {#advanced-bi-analytics}
            + [Översikt över avancerad BI Analytics](product-docs/reporting/advanced-bi-analytics/overview.md)
            + [Mätvärden och mått](product-docs/reporting/advanced-bi-analytics/metrics-and-dimensions.md)
   + Hantering av målkonto {#target-account-management}
      + Inställningar {#setup}
         ...
         + [Kontouppsättningsinställningar](product-docs/target-account-management/setup-tam/account-team-setup.md)
      ...
      + Target {#target}
         ...
         + [Skapa en kontomatchad publik på LinkedIn](product-docs/target-account-management/target/create-an-account-matched-audience-on-linkedin.md)
      + Engagera {#engage}
      ...
      + Mät {#measure}
         ...
         + [Dimension med namngivet konto i RCA](product-docs/target-account-management/measure/named-account-dimension-in-rca.md)
   ...
   + Web Personalization {#web-personalization}
      ...
      + Använda webbsegment {#using-web-segments}
         ...
         + [Skapa ett segment med en statisk lista](product-docs/web-personalization/using-web-segments/create-a-segment-using-a-static-list.md)
      ...
      + Arbeta med webbkampanjer {#working-with-web-campaigns}
         ...
         + [Ange hur din webbkampanj ska visas](product-docs/web-personalization/working-with-web-campaigns/set-how-your-web-campaign-displays.md)
         + [Sortera webbkampanjer efter senaste eller bäst presterande](product-docs/web-personalization/working-with-web-campaigns/sort-web-campaigns-by-latest-or-top-performing.md)
         + [Använda RTF-redigeraren för webbanpassning](product-docs/web-personalization/working-with-web-campaigns/using-the-web-personalization-rich-text-editor.md)
...
+ Versionsinformation {#release-notes}
   ...
   + [Lansering av dynamisk chatt](release-notes/dynamic-chat.md)
   + Tidigare versioner {#previous-releases}
      ...
      + 2024 {#2024}
         ...
         + [Uppdateringsinformation: Mars &#39;24](release-notes/previous-releases/2024/release-notes-mar-24.md)
         + [Uppdateringsinformation: April &#39;24](release-notes/previous-releases/2024/release-notes-apr-24.md)
      ...
      + 2023 {#2023}
         ...
         + [Versionsinformation: 23 maj](release-notes/previous-releases/2023/release-notes-may-23.md)
         + [Versionsinformation: 23 juli](release-notes/previous-releases/2023/release-notes-july-23.md)
         + [Versionsinformation: 23 september](release-notes/previous-releases/2023/release-notes-sep-23.md)
         + [Versionsinformation: 23 oktober](release-notes/previous-releases/2023/release-notes-oct-23.md)
      + 2022 {#2022}
         + [Versionsinformation: 22 januari](release-notes/previous-releases/2022/release-notes-jan-22.md)
         + [Versionsinformation: 22 mars](release-notes/previous-releases/2022/release-notes-mar-22.md)
         ...
         + [Uppdateringsinformation: Oktober &#39;22](release-notes/previous-releases/2022/release-notes-oct-22.md)
      + 2021 {#2021}
      ...
      + 2020 {#2020}
         ...
         + [Versionsinformation: 20 juni](release-notes/previous-releases/2020/release-notes-june-20.md)
         + [Versionsinformation: 20 juli](release-notes/previous-releases/2020/release-notes-july-20.md)
         + [Versionsinformation: 20 okt](release-notes/previous-releases/2020/release-notes-oct-20.md)
      + 2019 {#2019}
         + [Versionsinformation: 19 augusti](release-notes/previous-releases/2019/release-notes-august-19.md)
         + [Versionsinformation: 19 juni](release-notes/previous-releases/2019/release-notes-june-19.md)
         + [Versionsinformation: våren 19](release-notes/previous-releases/2019/release-notes-spring-19.md)
         + [Versionsinformation: Vinter 19](release-notes/previous-releases/2019/release-notes-winter-19.md)
      + 2018 {#2018}
         + [Versionsinformation: höst 18](release-notes/previous-releases/2018/release-notes-fall-18.md)
         + [Versionsinformation: våren 18](release-notes/previous-releases/2018/release-notes-spring-18.md)
         + [Versionsinformation: Vinter 18](release-notes/previous-releases/2018/release-notes-winter-18.md)
      + 2017 {#2017}
         + [Versionsinformation: 17 april-förbättringar av ABM](release-notes/previous-releases/2017/release-notes-april-17-abm-enhancements.md)
         + [Versionsinformation: Förbättringar i ABM 17 augusti](release-notes/previous-releases/2017/release-notes-august-17-abm-enhancements.md)
         + [Versionsinformation: höst 17](release-notes/previous-releases/2017/release-notes-fall-17.md)
         ...
         + [Versionsinformation: Vinter 17](release-notes/previous-releases/2017/release-notes-winter-17.md)
      + 2016 {#2016}
         + [Versionsinformation: höst 16](release-notes/previous-releases/2016/release-notes-fall-16.md)
         + [Versionsinformation: våren 16](release-notes/previous-releases/2016/release-notes-spring-16.md)
         + [Versionsinformation: Sommaren 16](release-notes/previous-releases/2016/release-notes-summer-16.md)
         + [Versionsinformation: Vinter 16](release-notes/previous-releases/2016/release-notes-winter-16.md)
      + 2015 {#2015}
         + [Versionsinformation: april 2015](release-notes/previous-releases/2015/release-notes-april-2015.md)
         + [Versionsinformation: höst 15](release-notes/previous-releases/2015/release-notes-fall-15.md)
         + [Versionsinformation: februari 2015](release-notes/previous-releases/2015/release-notes-february-2015.md)
         + [Versionsinformation: januari 2015](release-notes/previous-releases/2015/release-notes-january-2015.md)
         + [Versionsinformation: juli 2015](release-notes/previous-releases/2015/release-notes-july-2015.md)
         + [Versionsinformation: juni 2015](release-notes/previous-releases/2015/release-notes-june-2015.md)
         + [Versionsinformation: Mars 2015](release-notes/previous-releases/2015/release-notes-march-2015.md)
         + [Versionsinformation: maj 2015](release-notes/previous-releases/2015/release-notes-may-2015.md)
      + 2014 {#2014}
         + [Versionsinformation: augusti 2014](release-notes/previous-releases/2014/release-notes-august-2014.md)
         + [Versionsinformation: december 2014](release-notes/previous-releases/2014/release-notes-december-2014.md)
         + [Versionsinformation: februari 2014](release-notes/previous-releases/2014/release-notes-february-2014.md)
         + [Versionsinformation: januari 2014](release-notes/previous-releases/2014/release-notes-january-2014.md)
         + [Versionsinformation: juli 2014](release-notes/previous-releases/2014/release-notes-july-2014.md)
         + [Versionsinformation: juni 2014](release-notes/previous-releases/2014/release-notes-june-2014.md)
         + [Versionsinformation: Mars 2014](release-notes/previous-releases/2014/release-notes-march-2014.md)
         + [Versionsinformation: maj 2014](release-notes/previous-releases/2014/release-notes-may-2014.md)
         + [Versionsinformation: oktober 2014](release-notes/previous-releases/2014/release-notes-october-2014.md)
      + 2013 {#2013}
         + [Versionsinformation: april 2013](release-notes/previous-releases/2013/release-notes-april-2013.md)
         + [Versionsinformation: augusti 2013](release-notes/previous-releases/2013/release-notes-august-2013.md)
         + [Versionsinformation: december 2013](release-notes/previous-releases/2013/release-notes-december-2013.md)
         + [Versionsinformation: februari 2013](release-notes/previous-releases/2013/release-notes-february-2013.md)
         + [Versionsinformation: januari 2013](release-notes/previous-releases/2013/release-notes-january-2013.md)
         + [Versionsinformation: juli 2013](release-notes/previous-releases/2013/release-notes-july-2013.md)
         + [Versionsinformation: juni 2013](release-notes/previous-releases/2013/release-notes-june-2013.md)
         + [Versionsinformation: Mars 2013](release-notes/previous-releases/2013/release-notes-march-2013.md)
         + [Versionsinformation: maj 2013](release-notes/previous-releases/2013/release-notes-may-2013.md)
         + [Versionsinformation: oktober 2013](release-notes/previous-releases/2013/release-notes-october-2013.md)
         + [Versionsinformation: september 2013](release-notes/previous-releases/2013/release-notes-september-2013.md)
      + 2012 {#2012}
         + [Versionsinformation: april 2012](release-notes/previous-releases/2012/release-notes-april-2012.md)
         + [Versionsinformation: december 2012](release-notes/previous-releases/2012/release-notes-december-2012.md)
         + [Versionsinformation: jan/feb 2012](release-notes/previous-releases/2012/release-notes-jan-feb-2012.md)
         + [Versionsinformation: juni 2012](release-notes/previous-releases/2012/release-notes-june-2012.md)
         + [Versionsinformation: Mars 2012](release-notes/previous-releases/2012/release-notes-march-2012.md)
         + [Versionsinformation: maj 2012](release-notes/previous-releases/2012/release-notes-may-2012.md)
         + [Versionsinformation: oktober 2012](release-notes/previous-releases/2012/release-notes-october-2012.md)
         + [Versionsinformation: september 2012](release-notes/previous-releases/2012/release-notes-september-2012.md)
