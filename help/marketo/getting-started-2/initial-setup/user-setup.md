...
Nu när du är klar med alla [initiala inställningsuppgifter](/help/marketo/getting-started-2/initial-setup/initial-setup-tasks.md)är det dags att lägga till några grundläggande element för att säkerställa smidig kontinuerlig användning. Detta kommer att lägga grunden för din resa med Marketo Engage och hjälpa dig att få ut det mesta av dess funktioner. Kom så börjar vi!

>[!NOTE]
>
>Du kan även hämta checklistan [INFOGA LÄNK] och kolla upp stegen medan du går.
...
Nu när ditt Marketo Engage-konto är klart kan du gå igenom vår [Bästa praxis för en ny Marketo Engage-instans](/help/marketo/getting-started-2/implementing-a-new-marketo-engage-instance/where-to-start.md) för att få ut så mycket som möjligt av er investering och göra er redo för långsiktiga framgångar.
