...
Nedan finns definitioner för många av de termer som du kan stöta på när du använder Marketo. Om du vill begära att en term läggs till skickar du [ett e-postmeddelande](http://docs.marketo.com/cdn-cgi/l/email-protection#581f0a087515392a333d2c3775392a2c313b343d3e3d3d3c3a393b3318393c373a3d763b3735672b2d3a323d3b2c65192a2c313b343d781e3d3d3c3a393b3378757815392a333d2c37781f34372b2b392a21)till oss.
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/pages/viewpage.action?pageId=2359480" rel="nofollow">A/B-testning</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/x/nayt" rel="nofollow">Kontobaserad marknadsföring</a> (ABM)</strong></td> 
  ...
  <tr> 
   ...
   <td colspan="1">(tidigare AccountAI) I <strong>ABM</strong>kommer befintliga företag i din databas att rangordnas med din Ideal Customer Profile (ICP) och rankningarna läggs till som poäng på dina konton.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Account+Score" rel="nofollow">Kontopoäng</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/x/SrCt" rel="nofollow"><strong>Annonsnätverksintegrering </strong></a></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Send+Alert" rel="nofollow">Varning</a></strong></td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <div> 
     <p><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Batch+and+Trigger+Smart+Campaigns#UnderstandingBatchandTriggerSmartCampaigns-BatchSmartCampaign" rel="nofollow">Gruppkampanj</a></strong></p> 
    </div></td> 
  ...
  <tr> 
   <td><a href="http://docs.marketo.com/x/uwOQ" rel="nofollow"><strong>Blocklist</strong></a></td> 
  ...
  <tr> 
   <td> 
    <div> 
     <p><strong><a href="http://docs.marketo.com/display/DOCS/Hard+and+Soft+Bounces+in+Email" rel="nofollow">Studsa</a></strong></p> 
    </div></td> 
   <td>När ett e-postmeddelande som skickas till en mottagare returneras. Det finns hårda och mjuka studsar. Ett hårt studsande kan göra en persons e-postadress ogiltig när en e-postserver meddelar Market att personens e-postadress inte kan levereras. Ett mjukt studs innebär att något gick fel när e-postmeddelandet skickades till personen. detta löses automatiskt. Både hårda och mjuka studsar består av <a href="http://nation.marketo.com/docs/DOC-2752" rel="nofollow">flera kategorier</a>.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">"Campaign" kan betyda några saker i Marketo. En <a href="http://docs.marketo.com/x/oA8t" rel="nofollow">kampanj</a> är en kortare term för en smart kampanj. I <strong>Marketo Sales Connect</strong>är <a href="http://docs.marketo.com/x/6gDb" rel="nofollow">kampanjer</a> en serie korrespondenssteg för flera kanaler. I <strong>Webbpersonalisering</strong>är webbkampanjer <a href="http://docs.marketo.com/x/FQAt" rel="nofollow"></a> anpassade reaktioner som är kopplade till ett visst segment.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/public/DOCS/Campaign+Activity+Report" rel="nofollow">Kampanjaktivitetsrapport</a></strong></td> 
   <td colspan="1">Typ av rapportering som visar hur <strong>smarta kampanjer</strong> fungerar.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/public/DOCS/Campaign+Email+Performance+Report" rel="nofollow">Resultatrapport för e-postkampanj</a></strong></td> 
   <td colspan="1">Typ av rapportering som visar e-postresultatstatistik grupperade efter <strong>smart kampanj</strong>.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/public/DOCS/Create+New+Campaign+Folder" rel="nofollow">Campaign-mapp</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/public/DOCS/Understanding+Engagement+Programs#UnderstandingEngagementPrograms-Cast" rel="nofollow"><strong>Kast</strong></a></td> 
   <td colspan="1">En sändning är händelsen att skicka e-post från ett <strong>engagemangsprogram</strong>.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/public/DOCS/Create+a+Program+Channel" rel="nofollow"><strong>Kanal</strong></a></td> 
  ...
  <tr> 
   ...
   <td colspan="1">I Marketo kan du duplicera flera olika typer av enheter i instansen. Du kan klona <a href="http://docs.marketo.com/display/DOCS/Clone+a+Program" rel="nofollow">program</a>, en <a href="http://docs.marketo.com/display/DOCS/Clone+an+Asset+in+a+Program" rel="nofollow">resurs i ett program</a>, en <a href="http://docs.marketo.com/display/DOCS/Clone+a+Stream" rel="nofollow">ström</a>med mera.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/public/DOCS/Company+Web+Activity+Report" rel="nofollow"><strong>Webbaktivitetsrapport för företag</strong></a></td> 
   <td colspan="1">Typ av rapportering som visar vilka företag som besöker din webbplats.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/public/DOCS/Add+a+Constraint+to+a+Smart+List+Filter" rel="nofollow"><strong>Begränsning</strong></a></td> 
  ...
  <tr> 
   ...
   <td colspan="1">En del information som lagts till <strong>resurser</strong>, t.ex. <strong>e-post</strong> eller <strong>landningssidor</strong>. I <strong>engagemangsprogram</strong>finns det två typer av innehåll som du kan <a href="http://docs.marketo.com/display/DOCS/Understanding+Engagement+Programs#UnderstandingEngagementPrograms-Content" rel="nofollow">lägga till i strömmar</a>- e-post och <strong>program</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/Understanding+Content+Analytics" rel="nofollow"><strong>Innehållsanalys</strong></a></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Create+a+Custom+Audience+in+Facebook" rel="nofollow">Anpassad målgrupp</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Create+a+Custom+Field+in+Marketo" rel="nofollow">Anpassat fält</a></strong></td> 
   <td colspan="1">Ett icke-standardfält som användaren skapar för att uppfylla specifika behov. Anpassade fälttyper <a href="http://docs.marketo.com/display/DOCS/Custom+Field+Type+Glossary" rel="nofollow">har en egen ordlista</a>.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Marketo+Custom+Objects" rel="nofollow">Eget objekt</a></strong></td> 
  ...
  <tr> 
   ...
   <td colspan="1">Ett system som gör det möjligt för organisationer att hantera information om sina kunder/potentiella kunder. Marketo tillåter endast inbyggd integrering med två CRM: <a href="http://docs.marketo.com/display/DOCS/CRM+Sync" rel="nofollow">Salesforce och Microsoft Dynamics</a>.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">Dokumenten är korta för dokument och är hjälpartiklar som kunderna kan använda för att bättre förstå produkten. Marketo har flera olika typer av dokument: Produktdokument (den webbplats du för närvarande är på), <a href="http://help.marketo.com/hc/en-us" rel="nofollow">Marketo Sky</a> -dokument, <a href="http://developers.marketo.com/" rel="nofollow">utvecklardokument</a> och <a href="http://nation.marketo.com/community/support_solutions/content" rel="nofollow">supportdokument</a> .</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Set+up+SPF+and+DKIM+for+your+Email+Deliverability" rel="nofollow">Identifierad e-post</a> med domännycklar (DKIM)</strong></td> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/x/8Aea" rel="nofollow"><strong>Varaktigt avslut</strong></a></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Dynamic+Content" rel="nofollow">Dynamiskt innehåll</a></strong></td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colspan="1"> 
    <div> 
     <p><a href="http://docs.marketo.com/display/DOCS/Understanding+Email+Programs" rel="nofollow"><strong> E-postprogram</strong></a></p> 
    </div></td> 
   <td colspan="1">En programtyp i Marketo. E-postprogram används för engångsutskick via e-post. Du kan använda <strong><a href="http://docs.marketo.com/pages/viewpage.action?pageId=2359491" rel="nofollow">A/B-testning</a></strong> och spåra e-postresultaten.<br></td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/Understanding+Unsubscribe#UnderstandingUnsubscribe-EmailSuspended" rel="nofollow"><strong>E-post pausad</strong></a></td> 
  ...
  <tr> 
   <td><strong><a href="http://docs.marketo.com/x/fwIt" rel="nofollow">Händelse</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/LaunchPoint+Event+Partners" rel="nofollow">Evenemangspartner</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/People+Who+Have+Exhausted+Content" rel="nofollow"><strong>Utmattad</strong></a></td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td><a href="http://docs.marketo.com/display/public/DOCS/Sales+Engage+and+GDPR+Compliance" rel="nofollow"><strong>Allmänna dataskyddsförordningen (GDPR)</strong></a></td> 
...
| **Hård studs** | (se [**Studsa**](#bounce)) |
|---|---|

## I  {#i}

| [**Intressant stund**](http://docs.marketo.com/display/DOCS/Using+Interesting+Moments#UsingInterestingMoments-Whatisaninterestingmoment?) | I **Marketo Sales Insight**, en förekomst som du anser vara av särskild betydelse (t.ex. när någon besöker en viss sida på webbplatsen klickar du på en viss länk i ett e-postmeddelande) som du vill att ditt säljteam ska vara medvetna om. |
|---|---|

## K  {#k}

| **Känd person** | Persondata i Marketo- **databasen** betraktas som kända persondata. Det finns flera olika sätt att ange databasen: CRM-synkronisering, fylla i ett formulär, ange import/manuell inmatning, programmatisk (övriga API-/partnerintegrationer) med mera. Webbbesökare **kodas** först (och är anonyma) via Marketos **Munchkin** -webbspårning och mappas sedan till motsvarande kända personpost när identifierbara åtgärder utförs (t.ex. klickade på en spårad länk i ett Marketo-e-postmeddelande, fyllde i ett formulär med sin e-postadress eller mappas manuellt via Marketo för att associera lead-API:er i både [](http://developers.marketo.com/javascript-api/lead-tracking/api-reference/#munchkin_associatelead) och [REST API](http://developers.marketo.com/rest-api/endpoint-reference/lead-database-endpoint-reference/#!/Leads/AssociateLeadUsingPOST). |
|---|---|
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <div> 
     <p><a href="http://docs.marketo.com/display/DOCS/Landing+Pages" rel="nofollow"><strong> Landningssida</strong></a></p> 
    </div></td> 
   <td>En Marketo-hostingsida där du kan visa <strong>innehåll</strong> och spåra besökare. Det finns två olika typer: Frihand och guidad. <a href="http://docs.marketo.com/display/DOCS/Understanding+Free-form+vs+Guided+Landing+Pages#UnderstandingFree-formvsGuidedLandingPages-Free-formPages" rel="nofollow">Med landningssidor</a> med fritt format kan du dra och släppa allt innehåll du vill, var du vill. <a href="http://docs.marketo.com/display/DOCS/Understanding+Free-form+vs+Guided+Landing+Pages#UnderstandingFree-formvsGuidedLandingPages-GuidedPages" rel="nofollow">De guidade landningssidorna</a> är mer strikta och har en fördefinierad layout/struktur som bestäms av <strong>mallen</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>I <strong>Marketo Engage</strong>är lead den föregående termen (<a href="http://docs.marketo.com/x/GsOt" rel="nofollow">ersatt av <strong>person</strong></a>) som används för att beskriva en individ i er Marketo- <strong>databas</strong> som ni interagerar med genom era marknadsföringskampanjer. I din <strong>CRM</strong>kan ett lead representera ett annat koncept (dvs. en individ som är associerad med en <strong>affärsmöjlighet</strong>) oberoende av Marketos funktion.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Lead-databas</strong></td> 
   <td colspan="1">Föregående databasnamn (se <a href="#database"><strong>Databas</strong></a>).</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
   ...
   <td colspan="1">En samling människor. I Marketo finns det smarta listor och statiska listor. En <a href="http://docs.marketo.com/x/SoAI" rel="nofollow">smart lista</a> är en dynamisk lista med personer som kan ändras hela tiden, eftersom den baseras på filter som du definierar (t.ex. alla i databasen som bor i Kalifornien). När nya personer uppfyller kriterierna (eller befintliga personer inte längre är kvalificerade) ändras listan. En <a href="http://docs.marketo.com/x/AwMt" rel="nofollow">statisk lista</a> är statiska. Den ändras inte om du inte lägger till/tar bort någon manuellt.</td> 
  </tr> 
  <tr> 
   <td><a href="http://docs.marketo.com/display/DOCS/Understanding+Local+Assets+in+a+Program" rel="nofollow"><strong>Lokala resurser</strong></a></td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colspan="1"><a href="http://www.marketo.com/marketing-automation/" rel="nofollow"><strong>Marknadsföringsautomatisering</strong></a></td> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/Understanding+Unsubscribe#UnderstandingUnsubscribe-MarketingSuspended" rel="nofollow"><strong>Marknadsföring har pausats</strong></a></td> 
  ...
  <tr> 
   ...
   <td colspan="1">(se <strong><a href="#performanceinsights">Prestandainsikter</a></strong>)</td> 
  </tr> 
  <tr> 
   <td><strong><a href="http://docs.marketo.com/x/cITS" rel="nofollow">Marketo Sales Connect</a> (MSC)</strong></td> 
   <td>Kallas tidigare Marketo Sales Engage (MSE). Ett tilläggsverktyg för försäljning med flera aspekter som hjälper marknadsförarna att engagera sig i framtiden och spåra resultatet.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Nästa generation av Marketos gränssnitt. Det använder nya designer, arbetsflöden och funktioner som hjälper er att få ut mer av Marketo.</td> 
  </tr> 
  <tr> 
   <td><strong>Microsoft Dynamics</strong></td> 
   <td>Kallas även MSD. En av de två CRM-företagen Marketo har en inbyggd integrering med (se <a href="#crm"><strong>CRM</strong></a>).</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/Understanding+My+Tokens+in+a+Program" rel="nofollow"><strong>Mina token</strong></a></td> 
   <td colspan="1">Egna variabler som alla kan skapa. De <a href="../product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md" rel="nofollow">skapas</a> antingen i <strong>kampanjmappar</strong> eller i <strong>program</strong>.</td> 
  </tr> 
 </tbody> 
</table>
...
| **Namngivet konto** | I **ABM**&#x200B;är ett konto som användaren har fastställt ett målkonto som han/hon vill föra. |
|---|---|
| **Näringsprogram** | (se ** [Engagement Program](#engagementprogram)**) |
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>(se <a href="#unsubscribe"><strong>avbeställa</strong></a>)</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/x/zgIk" rel="nofollow"><strong>Prestandarapport för människor</strong></a></td> 
   <td colspan="1">En rapporttyp i Marketo. Det gör att du kan mäta <strong>databasens</strong> tillväxt över tid.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/x/JINy" rel="nofollow"><strong>Periodkostnad</strong></a></td> 
   <td colspan="1">De pengar ni spenderar under en viss månad på ett <strong>program</strong>.</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
     <p><a href="http://docs.marketo.com/x/PgvG" rel="nofollow"><strong> Prestandainsikter</strong></a></p> 
    </div></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Workspaces+and+Person+Partitions#UnderstandingWorkspacesandPersonPartitions-PersonPartitions" rel="nofollow">Personpartition</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/x/2AEk" rel="nofollow"><strong>Omröstning</strong></a></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Programs" rel="nofollow">Program</a></strong></td> 
   <td colspan="1">En behållare som innehåller allt du behöver för att utföra ett marknadsföringsinitiativ. Det finns fyra olika typer. (se <strong><a href="#eventprogram">Event Program</a></strong>, <strong><a href="#engagementprogram">Engagement Program</a></strong>, <a href="#emailprogram"><strong>Email Program</strong></a>och <strong><a href="#defaultprogram">Default Program</a></strong>)</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/Program+Performance+Report" rel="nofollow"><strong>Rapport om programprestanda</strong></a></td> 
...
| ** [Kvalificeringsregler](http://docs.marketo.com/x/XoAR)** | När en person uppfyller de förbestämda villkoren i en **smart kampanj** kvalificerar de sig för det. Du kan ange kvalificeringsregler för att bestämma hur många gånger de kan gå igenom **flödet** i den smarta kampanjen. |
|---|---|
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td><strong><a href="http://docs.marketo.com/x/lwIk" rel="nofollow">RCA (Revenue Cycle Analytics</a> )</strong></td> 
   <td>En tilläggsfunktion i innehåller olika verktyg som hjälper dig att förbättra rapporteringen i alla instanser.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/display/DOCS/Understanding+Revenue+Models" rel="nofollow"><strong>Intäktsmodell</strong></a></td> 
  ...
  <tr> 
   ...
   <td colspan="1">En e-postadress som tillhör en avdelning eller befattning (t.ex. <a href="http://docs.marketo.com/cdn-cgi/l/email-protection">[e-postskyddad]</a>, <a href="http://docs.marketo.com/cdn-cgi/l/email-protection">[e-postskyddad]</a>osv.), inte till en enskild person. Marketo blockerar e-post från att skickas till <a href="http://nation.marketo.com/community/support_solutions/blog/2018/11/30/suppressing-addresses-to-protect-customers-the-network" rel="nofollow">specifika rollkonton</a> som inte kan associeras med en enskild prenumerant.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">Kallas även SFDC. En av de två CRM-företagen Marketo har en inbyggd integrering med (se <a href="#crm"><strong>CRM</strong></a>).</td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="http://docs.marketo.com/x/2IER" rel="nofollow"><strong>E-postexempel</strong></a></td> 
   <td colspan="1">Ett <strong>testmeddelande</strong> som du skickar till dig själv (och/eller andra) för att se hur det ser ut innan du skickar det till dina kunder. Du kan också använda exempel för att testa <strong>dynamiskt innehåll</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Dynamic+Content#UnderstandingDynamicContent-Segmentation" rel="nofollow">Segmentering</a></strong></td> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/display/DOCS/Set+up+SPF+and+DKIM+for+your+Email+Deliverability" rel="nofollow">SPF (Sender Policy Framework</a> )</strong></td> 
  ...
  <tr> 
   ...
   <td colspan="1">Ett av de viktigaste verktygen i Marketo. De utför åtgärder som du anger baserat på kriterier som du bestämmer. (se även <strong><a href="#batchcampaign">Gruppkampanj</a></strong> och <strong><a href="#triggercampaign">Utlös kampanj</a></strong>)</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Smart List</strong></td> 
   <td colspan="1">(se <a href="#list"><strong>Lista</strong></a>)</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/x/owAk" rel="nofollow">Fragment</a></strong></td> 
  ...
  <tr> 
   ...
   <td colspan="1">(se <a href="#bounce"><strong>Studsa</strong></a>)</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>(se <a href="#list"><strong>Lista</strong></a>)</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="http://docs.marketo.com/x/6wEk" rel="nofollow">Strömma</a></strong></td> 
   <td colspan="1">En samling prioriterat <strong>innehåll</strong> som används i ett <strong>engagemangsprogram</strong> för att främja människor. <a href="http://docs.marketo.com/x/awEk" rel="nofollow">Innehållet</a> distribueras i den ordning du anger.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td><strong><a href="http://docs.marketo.com/x/6IAR" rel="nofollow">Taggar</a></strong></td> 
  ...
  <tr> 
   ...
   <td>En aktivitet eller händelse som aktiverar <a href="http://docs.marketo.com/x/PoAR" rel="nofollow">flödesstegen för en utlösarkampanj</a> när händelsen inträffar (t.ex. någon besöker en webbsida, klickar på en länk i ett e-postmeddelande). </td> 
  </tr> 
  <tr> 
   <td> 
    <div> 
     <p><a href="http://docs.marketo.com/display/DOCS/Understanding+Batch+and+Trigger+Smart+Campaigns#UnderstandingBatchandTriggerSmartCampaigns-TriggerSmartCampaign" rel="nofollow"><strong> Utlös kampanj</strong></a></p> 
    </div></td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td><strong><a href="http://docs.marketo.com/display/DOCS/Understanding+Unsubscribe#UnderstandingUnsubscribe-Unsubscribed" rel="nofollow">Avbeställ</a></strong></td> 
...
| **Webbkampanj** | En anpassad reaktion som är kopplad till ett visst segment. I **Webbpersonalisering** innehåller webbkampanjer [dialogrutor](http://docs.marketo.com/x/JgNI), [I zoner](http://docs.marketo.com/x/KANI)och [widgetar](http://docs.marketo.com/x/KgNI). |
|---|---|
| [**Aktivitetsrapport för webbsida**](http://docs.marketo.com/x/owIk) | En rapporttyp i Marketo. Här kan du se kända *eller* anonyma personer som besöker din webbplats. |
| ** [Webbanpassning](http://docs.marketo.com/x/HQMk)** | En tilläggsfunktion som tillhandahåller en plattform för målinriktning och personalisering, som hjälper Marketo-användare att engagera kända och anonyma besökare i realtid, baserat på vilka de är och vad de gör. |
| **Webbinarium** | Ett webbaserat seminarium. I Marketo kan webbinarier genomföras via ett antal olika ** [event partners](http://docs.marketo.com/x/kQIt)**. |
| [**Återmarknadsföring av webbplatser**](http://docs.marketo.com/x/FRSa) | En tilläggsfunktion som hjälper Marketo-användare att målinrikta kända och anonyma besökare (via Facebook och Google) med relevanta annonser baserade på bransch, namngivna konton och kända data. |
| **Vad du ser är vad du får (WYSIWYG)** | En vanlig term som refererar till ett program eller en redigerare som gör att du kan se slutresultatet av ditt **innehåll** när du skapar det. Marketo har en WYSIWYG-redigerare. |
| **Widget** | Ett litet grafiskt element i ett program som tillåter en viss interaktion. Widgetar är bara tillgängliga i Marketo Sky (andra än en [webbkampanj](http://docs.marketo.com/x/KgNI)för widget). |
| **Jokertecken** | Ett tecken (* används i **Webbanpassning**) som används före eller efter en sträng för att ersätta andra tecken i en sträng. |
| ** [Arbetsyta](http://docs.marketo.com/display/DOCS/Understanding+Workspaces+and+Person+Partitions#UnderstandingWorkspacesandPersonPartitions-Workspaces)** | Ett separat område i Marketo som innehåller marknadsföringsresurser ****. Du kan till exempel ha en arbetsyta som heter&quot;Nordamerika&quot; som du använder strikt för att marknadsföra i den regionen. Europa, Asien osv. |
