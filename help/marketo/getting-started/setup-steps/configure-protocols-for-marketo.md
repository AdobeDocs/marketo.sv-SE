...
>[!NOTE]
>
>Den här artikeln är avsedd att läsas av IT-avdelningen på det företag som vill implementera dessa protokoll.
...
・ Alias: Ange `[YourLandingPageCNAME]` (tillhandahålls via marknadsföring) ・ Typ: CNAME\
...
>[!NOTE]
>
>Postini använder en unik teknik och kräver tillåtslista IP-intervall. Se [Tillåtslista med Postini](http://nation.marketo.com/docs/DOC-1066).
...
1. Om du vill konfigurera SPF lägger du till följande rad i våra DNS-poster:
   ...
   inkludera: [mktomail.com](http://mktomail.com/) ~alla

   Om det redan finns en SPF-post i vår DNS-post lägger du bara till följande:\
   inkludera: [mktomail.com](http://mktomail.com)
...
1. För DKIM skapar du DNS-resursposter för varje domän som vi vill konfigurera. Nedan visas värdposter och TXT-värden för varje domän som vi ska signera för:
   ...
   Kopiera HostRecord och TXTValue för varje DKIMDomain som du har konfigurerat efter att ha [instruktionerna här](https://docs.marketo.com/display/public/DOCS/Set+up+a+Custom+DKIM+Signature). Glöm inte att verifiera varje domän i Admin > E-post > DKIM när din IT-personal har slutfört det här steget.
