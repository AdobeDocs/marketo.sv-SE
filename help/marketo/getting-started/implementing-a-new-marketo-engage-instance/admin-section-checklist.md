...
<tbody>
  ...
  <tr>
    ...
    <li>Slutför de <a href="https://experienceleague.adobe.com/sv/docs/marketo/using/product-docs/marketo-sales-connect/getting-started/getting-started-guide-for-sales-connect-admins" target="_blank">ytterligare administratörsinställningarna för Sales Connect</a> i Sales Connect och Salesforce.</li></td>
  </tr>
  <tr>
