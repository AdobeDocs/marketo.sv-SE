...
<table>
 <tbody>
  ...
  <tr>
   ...
   <p>
   <li>Hur många användare finns det?</li>
...
<p><img src="assets/note-icon.png" alt="anteckningsikon"> Obs! Vi rekommenderar att du begränsar din kommunikation till 1 per dag och 3 per 7 dagar, med e-post som inte är <b>-</b>aktiv<a href="/help/marketo/product-docs/email-marketing/general/functions-in-the-editor/make-an-email-operational.md" target="_blank"> blockerade.</a></td>
  </tr>
 </tbody>
</table>
