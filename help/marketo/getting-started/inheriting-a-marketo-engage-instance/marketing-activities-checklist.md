...
Ordna avsnittet marknadsföringsaktiviteter på rätt sätt så att andra kan hitta och hantera olika program i din Marketo Engage-instans och se till att människor bearbetas för att gå från marknadsföring till försäljning. Kom ihåg att [hämta checklistorna](/help/marketo/getting-started/inheriting-a-marketo-engage-instance/assets/adobe-marketo-engage-inherited-instance-admin-checklist.xlsx) och spåra dina framsteg.
...
<li>Synkroniseras alla program <a href="/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md" target="_blank">till SFDC-kampanjer</a> (om tillämpligt)?</li>
...
<li>Har du stött på några personer i flera engagemangsprogram? Borde de vara i mer än en?</li></td>
  ...
  <tr> 
   ...
   <td><li>Hur många återkommande <a href="/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/understanding-batch-and-trigger-smart-campaigns.md#batch-campaign" target="_blank">batchkampanjer</a> finns det?</li>
