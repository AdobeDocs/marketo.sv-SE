---
description: Läs om Dynamic Chat filter och utlösare för smarta listor. Använd triggade, engagerade och målfärdiga händelser för att segmentera och automatisera i Marketo.
