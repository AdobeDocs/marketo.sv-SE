---
description: Lär dig hur du använder personattribut för Demandbase i Dynamic Chat för dialoger och routning. Hämta API-nyckeln och aktivera integreringen.
title: Demandbase
