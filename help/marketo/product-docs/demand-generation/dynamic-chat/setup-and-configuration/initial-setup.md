---
description: Lär dig hur du konfigurerar Dynamic Chat för din Marketo-instans. Få tillgång till Admin Console, lägg till användare och anslut Dynamic Chat till Marketo.
