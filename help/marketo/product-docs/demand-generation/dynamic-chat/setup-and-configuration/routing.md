---
description: Läs om hur du dirigerar möten och live-chatt i Dynamic Chat. Skapa personliga regler eller anpassade regler för att tilldela besökare till specifika agenter eller team.
title: Routning
