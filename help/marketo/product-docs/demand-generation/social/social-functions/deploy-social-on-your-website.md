...
1. Välj **Bädda in kod** från funktionsmakron för sociala appar.
...
1. Om du behöver ange storleken på den sociala appen till specifika dimensioner på sidan lägger du till **outerHeight** och **outerWidth** till det andra kodfragmentet. Du kan till exempel lägga till `options='{"outerHeight":400, "outerWidth":600}'`, som i:
