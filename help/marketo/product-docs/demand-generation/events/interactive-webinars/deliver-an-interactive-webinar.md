---
description: Lär dig leverera ett interaktivt webbinarium i Marketo. Kör live-eventet och använd engagemangsverktygen för att ansluta till deltagarna.
...
Läs mer om [Simulerade webbinarier](https://helpx.adobe.com/se/adobe-connect/using/webinar/overview-of-simulated-live-webinars.html){target="_blank"}.
