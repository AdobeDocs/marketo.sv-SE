...
>[!NOTE]
>
>Läs mer i [Marketo API-dokumentation](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/rest-api){target="_blank"} för mer information om Marketo API:er.
