...
1. Klicka på **..** och klicka sedan på **Skicka Marketo-e-post**.
   ...
   >[!TIP]
   >
   >Du kan [publicera e-postmeddelanden som mallar](../../../../product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/send-marketo-email/publish-an-email-to-sales-insight.md) så att säljteamet kan använda dem.
