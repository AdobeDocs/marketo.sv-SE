...
description: Lär dig konfigurera Sales Insight för icke-ursprungliga Salesforce-integreringar. Konfigurera MSI när Marketo ansluter till Salesforce via anpassad synkronisering.
