...
# Installera Marketo Insights för [!DNL Google Chrome] {#install-marketo-insights-for-google-chrome}
...
1. Högerklicka på Marketo logotyp i [!DNL Chrome] och välj **[!UICONTROL Options]**.

   ![](assets/two.png)

1. Ange din **[!UICONTROL Reg code]**, **[!UICONTROL Email Address]**, **[!UICONTROL First Name]** och **[!UICONTROL Last Name]**. Klicka på **[!UICONTROL Verify and Save]**.
...
1. Klicka på **[!UICONTROL Allow]** om du vill tillåta offlineåtkomst.
