---
description: Lär dig mer om dynamiska fält i mallar för Sales Insight Actions. Använd kopplingsfält för att anpassa e-postmeddelanden med kontakt- och avsändardata.
