...
description: Så här lägger du till länkfält för att koppla anpassade objekt till personer eller företag för en-till-många- och många-till-många-strukturer, inklusive användning av mellanliggande objekt.
