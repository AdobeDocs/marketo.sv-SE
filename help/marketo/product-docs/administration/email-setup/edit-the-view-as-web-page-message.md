...
1. Redigera **Visa som webbsidesHTML** och **Visa som webbsidestext **versioner efter dina önskemål och klicka på **Spara ändringar**.
...
`<pre data-theme="Confluence"><div style="text-align: center"><font face="Verdana" size="1">To view this email as a web page, <a href="%mkt_webview_url%?mkt_tok=##MKT_TOK##">click here</a></font></div></pre>` **Visa som webbsidestext:**
