---
description: Så här aktiverar du behörigheten Använd formulärvalideringsregler och skapar globala regler som blockerar specifika domäner från att skicka till Marketo Engage-formulär.
