...
>[!MORELIKETHIS]
>
>Bra gjort! Nu ska vi [skapa en Endast API-användare](/help/marketo/product-docs/administration/users-and-roles/create-api-only-user.md).
