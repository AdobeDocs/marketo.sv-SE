...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Skapa</td> 
   <td>Kanaltypen "kanaltyp"<br><br>ellerKlonad från "programnamn"</td> 
  </tr> 
  <tr> 
   <td>Byt namn</td> 
  ...
  <tr> 
   <td>Klona</td> 
   <td>Klonad till "Design studio" i mappen "foldername" <br>Namnet"<br><br>ellerKlonad till"Marketing Activity" i programmet"<br>Klonat resursnamn"name"</td> 
  </tr> 
  <tr> 
   <td>Flytta</td> 
   <td>Flyttad till "Design studio" i mappen "folder name"<br><br>ellerFlyttad till "Marketing tasks" i programmet "program name"</td> 
  </tr> 
  <tr> 
   <td>Godkänn</td> 
   <td>Ej tillämpligt</td> 
  ...
  <tr> 
   <td>Utkast</td> 
   <td>E-postmeddelandet har skrivits ut eftersom fragmentets"kodavsnittsnamn" godkändes<br><br>eller så har e-postmeddelandet skrivits eftersom mallens"mallnamn" godkändes</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td>Klona</td> 
   <td>Klonat till "mappnamn" <br> Namnet "namn" på den klonade resursen</td> 
  </tr> 
  <tr> 
   <td>Godkänn</td> 
   <td>Ej tillämpligt</td> 
  ...
  <tr> 
   <td>Ändra programström</td> 
   <td>Lägg till<br>contentSteam name "stream name"<br>Skriv "Email" eller "Program"<br>Name "email name" eller "program name"<br>Smart Campaign "smart campaign name"</td> 
  </tr> 
  <tr> 
   <td>Ändra programström</td> 
   <td>Aktivera<br>contentStream-namnet "stream name"<br>Innehållsnamn "email name" eller "program name"</td> 
  </tr> 
  <tr> 
   <td>Ändra programström</td> 
   <td>Inaktivera<br>contentStream-namnet "stream name"<br>Innehållsnamn "email name" eller "program name"</td> 
  </tr> 
  <tr> 
   <td>Ändra programström</td> 
   <td>Ta bort<br>contentStream-namnet "stream name"<br>Innehållsnamn "email name" eller "program name"</td> 
  </tr> 
  <tr> 
   <td>Ändra programtoken</td> 
   <td>Lägg till token "token name"-värdet "token value"</td> 
  ...
  <tr> 
   <td>Klona</td> 
   <td>Klonad till "Design studio" i mappen "foldername"<br>Namnet"<br>Klonad resurs-URL"www.url.com"<br><br>ellerKlonad till"Marknadsföringsaktiviteter" i programmet"Programnamn" <br>Namnet"<br>Klonad resurs-URL"www.url.com"</td> 
  </tr> 
  <tr> 
   <td>Flytta</td> 
  ...
  <tr> 
   ...
   <td>Skapa</td> 
   <td><p><br><br>BlankorKlonad från "resursnamn"</p></td> 
  </tr> 
  <tr> 
   <td>Ta bort</td> 
   <td>Ej tillämpligt</td> 
  ...
  <tr> 
   <td>Klona</td> 
   <td>Klonad till "Person Database" i mappen "foldername" <br>Namnet "name"<br><br>ellerKlonad till "Marketing Activities" i programmet "Program name"<br>Klonat resursnamn "name"</td> 
  </tr> 
  <tr> 
   <td>Ta bort</td> 
   <td>Ej tillämpligt</td> 
  ...
  <tr> 
   <td>Flytta</td> 
   <td>Flyttad till "Program" i programmet "Program"<br><br>eller "Flyttad till "Mappar" i mappen "folder name"</td> 
  </tr> 
  <tr> 
   <td>Byt namn</td> 
   <td>Nytt namn, tidigare namn</td> 
  ...
  <tr> 
   <td>Klona</td> 
   <td>Klonat till Program i <br>programnamnet Klonat resursnamn<br><br>eller Klonat till Mapp i mappen "Mappnamn"<br>Klonat resursnamn "namn"</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td>Klona</td> 
   <td>Klonat till "mappnamn", <br>det klonade fragmentnamnet "namn"</td> 
  </tr> 
  <tr> 
   <td>Godkänn</td> 
   <td>Används av # resurser</td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Skapa</td> 
   <td>Roll skapad med rollnamn (Obs! om du behöver information om behörigheter som lagts till, kontakta support) - <br>visar en ögonblicksbild av behörigheter som tilldelats rollen</td> 
  </tr> 
  <tr> 
   <td>Ta bort</td> 
  ...
  <tr> 
   ...
   <td>Skapa (bjud in)</td> 
   <td>Användare inbjuden med: E-postadress, namn för- och efternamn, åtkomst förfaller tom eller med ett datum, API-användare sant eller falskt - <br>visar en ögonblicksbild av roller och arbetsytor som tilldelats användaren</td> 
  </tr> 
  <tr> 
