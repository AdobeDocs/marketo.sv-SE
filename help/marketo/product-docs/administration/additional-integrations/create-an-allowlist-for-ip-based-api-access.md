...
>[!CAUTION]
>
>Om du aktiverar den här funktionen kan du inte komma åt [Marketo MCP-servern](https://experienceleague.adobe.com/sv/docs/marketo-developer/marketo/mcp-server){target="_blank"} just nu. Detta förväntas bli löst i en kommande version.
