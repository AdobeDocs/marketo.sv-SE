...
1. Klicka **Nytt** och sedan **Ny segmentering**.
...
1. Ange **Namn**, klicka **Lägg till segment** och ge den ett namn.
...
1. Dra och släpp segmenten runt för att ändra deras ordning. När du är klar klickar du på **Skapa**.

   ![](assets/image2014-9-15-10-3a1-3a30.png)

   >[!NOTE]
   >
   >En person kvalificerar sig för det första matchande segmentet i [order](/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/segmentation-order-priority.md) definierad.
