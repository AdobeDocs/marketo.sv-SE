...
[!DNL Sales Connect]s rekommenderade mallar hjälper dig att få rätt meddelanden samtidigt som du sparar tid. Detta ger ett större flöde när du skickar e-post och minskar osäkerheten när du försöker hitta rätt e-post för rätt person.

1. Gå till fliken [!UICONTROL Templates].

1. Markera den mall som du vill rekommendera och klicka på **Redigera**.

1. Om du vill aktivera funktionen Rekommenderad mall för mallen kontrollerar du **[!UICONTROL Auto-Suggest this template when]**.

## Alla jämfört med {#all-vs-any}

Nu är det dags att välja dina villkorsinställningar. Välj **[!UICONTROL All]** om du vill att mallen ska rekommenderas när alla villkor är uppfyllda. Välj **[!UICONTROL Any]** om du vill att mallen ska rekommenderas när något av villkoren uppfylls.
...
**[!UICONTROL Does not Equal]**: Värdet måste vara vad som helst men en exakt matchning (t.ex. marknadsföringsnation är inte lika med marknadsföring)
...
Spara mallen när du har angett villkor. Härifrån kommer [!DNL Sales Connect] att arbeta med sin magi och visa upp de bästa mallarna för dig.
