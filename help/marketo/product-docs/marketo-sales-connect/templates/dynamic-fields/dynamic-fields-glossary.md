...
description: Läs mer om dynamiska fält i Sales Connect. Använd den här ordlistan för att hitta tillgängliga kopplingsfält för mallar och personalisering.
