...
description: Få svar på frågor om innehåll och bifogade filer i Sales Connect. Lär dig storleksbegränsningar, spårning och alternativ för bilagor.
...
**Innehåll** är det vi använder för att beskriva filer (PPT, PDF, Word, osv.) som du vill ska spåras av [!DNL Sales Connect].
...
På den mottagande sidan klickar mottagaren på länken och innehållet fylls i i webbläsaren. På så sätt kan vi spåra varje sidvy och rapportera dem till [!DNL Sales Connect]-användaren i Live-feed.

Fil- och innehållsalternativ är tillgängliga i: engångskommunikation via e-post, mallar, kampanjer, [!DNL Outlook] (både [!DNL Windows] och Mac), Gmail och OWA.

## Vem hanterar innehållet och var lagras det? {#who-manages-the-content-and-where-is-it-stored}

Innehåll kan överföras till databasen [!DNL Sales Connect] av alla användare som kan skapa mallar. Det innebär att användarna kan ladda upp valfritt innehåll.
