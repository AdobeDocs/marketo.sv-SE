...
description: Få hjälp när ett test-e-postmeddelande inte visades i Sales Connect. Felsök vyspårning för test- eller förhandsgranskningsmeddelanden.
...
1. Gå till [[!UICONTROL Command Center]](https://toutapp.com/).

1. Leta reda på e-postmeddelandet som du skickade själv i [!UICONTROL Sent folder] och markera det.

1. Klicka på knappen **[!UICONTROL Details]**. Du borde se dina egna vyer dyka upp där.
