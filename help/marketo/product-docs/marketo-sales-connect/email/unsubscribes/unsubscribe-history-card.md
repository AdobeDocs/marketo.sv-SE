...
Kortet [!UICONTROL Unsubscribe History] hjälper administratörer och användare att få sammanhangsberoende information om kontaktens avbeställningshistorik.

>[!NOTE]
>
>Klicka på fliken [!UICONTROL People] och välj en person för att komma hit. Det finns längst ned på fliken [!UICONTROL About] i vyn Personinformation (om de har avbrutit prenumerationen).
