...
När du skickar ett e-postmeddelande med [!DNL Marketo Sales Connect] spåras vyer (e-post öppnas) och klickningar (länkar som du klickar på).
...
>* Konfigurera en leveranskanal för [[!DNL Outlook]](/help/marketo/product-docs/marketo-sales-connect/email-plugins/msc-for-outlook/email-connection-for-outlook-users.md) eller [Gmail](/help/marketo/product-docs/marketo-sales-connect/email-plugins/gmail/email-connection-for-gmail-users.md)
...
1. Ange namnet eller e-postadressen för en mottagare i fältet **[!UICONTROL To]**.

   ![](assets/two.png)

   >[!NOTE]
   >
   >Du kan bara ha en person i fältet **[!UICONTROL To]**.
...
1. Lägg till de mottagare som du vill ska vara CC eller BCC i respektive fält.
   ...
   >[!NOTE]
   >
   >Om någon som har varit en CC’d eller BCC’d öppnar e-postmeddelandet, spelas den öppningen in som en vy på personens post i fältet **[!UICONTROL To]**.
...
1. Skriv e-postmeddelandet med redigeraren. Klicka på **[!UICONTROL Send]** (eller [Schema](/help/marketo/product-docs/marketo-sales-connect/email/using-the-compose-window/scheduling-an-email.md) om du vill) när du är klar.
