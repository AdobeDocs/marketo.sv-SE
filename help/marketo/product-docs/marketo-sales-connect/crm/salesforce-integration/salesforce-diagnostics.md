...
**Vad är det som händer:** Användare har inte skrivåtkomst till anpassade Tout-fält som behövs för att kunna utföra loggningstransaktionen Senaste aktivitet. Team kan ha installerat paket men har inte aktiverat rätt fält för användarna.\
