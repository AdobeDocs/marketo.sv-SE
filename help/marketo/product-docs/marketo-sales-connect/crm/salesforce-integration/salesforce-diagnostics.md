...
**Vad händer:** Befintliga felaktiga data i [!DNL Salesforce] verkställs vid uppdatering.\
**Felsökningssteg:** Se ovan.
...
**Vad händer:** Vi försöker komma åt din [!DNL Salesforce], men du har IP-begränsningar som hindrar oss från att göra det.\
...
**Vad händer:** Prestandaproblem med [!DNL Salesforce], troligtvis på grund av att kunden inte har optimalt resultat\
