...
description: Förstå aktivitetstypsfältet för uppgifter när du synkroniserar Sales Connect till Salesforce. Se hur uppgiftstyper mappas och visas i Salesforce.
