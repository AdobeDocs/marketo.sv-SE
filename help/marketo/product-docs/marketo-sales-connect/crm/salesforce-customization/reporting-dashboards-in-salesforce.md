...
description: Läs om hur du rapporterar instrumentpaneler i Salesforce som använder Sales Connect-data. Visa samtal och e-postaktivitet i Salesforce rapporter och kontrollpaneler.
