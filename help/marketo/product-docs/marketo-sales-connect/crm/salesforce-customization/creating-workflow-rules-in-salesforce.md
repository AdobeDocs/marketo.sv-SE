...
description: Lär dig hur du skapar arbetsflödesregler i Salesforce för Sales Connect-aktiviteter. Automatisera åtgärder när Sales Connect loggar e-post eller samtal.
