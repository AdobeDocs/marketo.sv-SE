...
description: Lär dig hur du använder gruppåtgärder i Salesforce Lightning med Sales Connect. Skicka flera leads eller kontakter till Sales Connect samtidigt.
