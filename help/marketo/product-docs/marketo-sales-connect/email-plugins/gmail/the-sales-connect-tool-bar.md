...
description: Läs mer om verktygsfältet Sales Connect i Gmail. Använd verktygsfältet för plugin-program för att infoga mallar, spåra e-postmeddelanden och logga in på Salesforce.
