...
description: Läs mer om sidan Sales Connect Analytics och e-postinteraktionsdata. Visa status för individer och team på flikarna Me, Team och Content.
...
# [!UICONTROL Analytics] Sidöversikt {#analytics-page-overview}

Fliken [!UICONTROL Analytics] är den plats där du ser data om e-posternas engagemang. Både data för individer och team visas. Administratörer kan också filtrera efter användaren på fliken [!UICONTROL Me].
...
Fliken [!UICONTROL Me] är en bra plats att kontrollera hur dina e-postmeddelanden, mallar och länkar fungerar. Om du är administratör i [!DNL Sales Connect] kan du filtrera efter alla användare i ditt team för att se deras status.
