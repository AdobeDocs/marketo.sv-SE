...
1. Gå till **[!UICONTROL Pages]section**.
...
| [!UICONTROL To Do] box | Visar antalet öppna problem med sidan som du är på. |
...
| [!UICONTROL Facebook Shares] | Antal gånger som den här sidan delades [!DNL Facebook]. |
| [!UICONTROL Facebook Likes] | Antal gånger som den här sidresursen har gillats [!DNL Facebook]. |
...
The [!UICONTROL Page Optimization Results] anger exakt vilka steg du behöver utföra för att öka optimeringspoängen/göra bättre sökningar på den här sidan.
