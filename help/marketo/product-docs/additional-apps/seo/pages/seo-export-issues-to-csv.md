...
Lär dig hur du exporterar sidutgivningsdata till en CSV-fil om du tänker dela den informationen med personer utanför Marketo.
...
1. Klicka på sidan som du vill se information för.

   ![](assets/seo-export-issues-to-csv-2.png)

   Siddetaljdetaljdetaljdetaljnivån nedåt visas. **[!UICONTROL Page Optimization Results]** är en lista över alla problem med den aktuella sidan.
