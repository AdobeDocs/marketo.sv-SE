...
description: Exportera sidoptimeringsproblem till en CSV-fil från detaljnivån för att dela utanför Marketo.
title: SEO - Exportera problem till CSV
exl-id: a3012408-eeb4-4f09-af01-5c0e5dec4625
hide: true
hidefromtoc: true
feature: SEO
source-git-commit: 88b2841cd9283b09224f579c8bec4f1fd4bc7bd5
workflow-type: tm+mt
...
Du kan exportera dina sidutgivningsdata till en CSV-fil om du vill dela den informationen med personer utanför Marketo. Så här gör du.
...
1. Klicka på sidan som du vill se information om.
   ...
   Det här är detaljnivån för sidan nedåt. **[!UICONTROL Page Optimization Results]** är en lista över alla problem med den aktuella sidan.
