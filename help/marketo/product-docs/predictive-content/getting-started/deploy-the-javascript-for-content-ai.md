...
Om du vill använda Predictive Content måste du skapa och konfigurera RTP (Web Personalization) `tag.`
...
1. Leta reda på den relevanta domänen i **Domänkonfiguration** och klicka på **Generera tagg.**
...
1. Bekräfta att växlingsknappen Tagg är **PÅ**.
