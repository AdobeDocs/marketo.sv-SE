...
description: Lär dig hur du implementerar rtp med adobe-tagghanteraren i Marketo Engage, inklusive implementering av rtp med adobe-tagg. Slutför nästa steg med den här guiden.
