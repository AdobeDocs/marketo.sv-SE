...
description: Lär dig hur du skapar ett segment med hjälp av en statisk lista i Marketo Engage genom att skapa ett segment med hjälp av en statisk lista. Slutför nästa steg med den här guiden.
