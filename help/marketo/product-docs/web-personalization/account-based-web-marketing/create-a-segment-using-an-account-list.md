...
1. Ange ett namn för segmentet. Dra och släpp **[!UICONTROL Account Lists]** från avsnittet **[!UICONTROL Firmographics]**.
...
1. Klicka på **[!UICONTROL Save]** eller klicka på **[!UICONTROL Save & Define Campaign]** för att gå till sidan Kampanjer.
