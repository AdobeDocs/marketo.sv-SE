...
Förutom Mina token kan du även använda alla inbyggda tokens i dina program. Kolla in [tokenöversikt](/help/marketo/product-docs/demand-generation/landing-pages/personalizing-landing-pages/tokens-overview.md).
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Använd den här variabeln för att <a href="../../../../product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md">lägga till en kalenderhändelsefil (.</a><a href="../../../../product-docs/email-marketing/general/functions-in-the-editor/create-a-calendar-event-ics-file.md">ics)</a> till e-postmeddelanden och landningssidor.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Använd den här token i <a href="../../../../product-docs/core-marketo-concepts/smart-campaigns/flow-actions/use-tokens-in-flow-steps.md">ändringsspåret</a>. </td> 
  </tr> 
  <tr> 
...
>[!CAUTION]
>
>Mina token kommer inte att matchas när du skickar ett e-postmeddelande från Sales Insight på antingen Microsoft Dynamics eller Salesforce. endast standardtokens fylls i (Lead, Company, etc.). Standardvärden för token *fungerar* dock.
