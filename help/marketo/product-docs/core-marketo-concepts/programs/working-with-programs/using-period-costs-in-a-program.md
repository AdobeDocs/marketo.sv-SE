...
A [periodkostnad](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-period-costs.md) är det belopp du spenderar på ett program. Den kan vara i en eller flera månader och används för att rapportera ROI.

## Lägg till en periodkostnad  {#add-a-period-cost}

1. Gå till **Inställningar** -fliken i ditt program.
...
1. Klicka på kalenderikonen. Välj en månad. Klicka **OK**.

   ![](assets/image2014-9-18-12-3a10-3a13.png)

1. Ange **Periodkostnad** (utan decimaler eller kommatecken). Klicka **Spara**.
