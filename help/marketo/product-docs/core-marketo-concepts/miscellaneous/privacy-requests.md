---
description: Lär dig hur du hanterar sekretessförfrågningar för åtkomst och borttagning i Marketo. Skicka förfrågningar via Privacy Service användargränssnitt eller API och bearbeta konsumentdata.
