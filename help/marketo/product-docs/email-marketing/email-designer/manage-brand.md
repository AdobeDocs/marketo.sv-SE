...
1. Klicka på ikonen **[!UICONTROL Writing Style]**+**på fliken** för att lägga till en stödlinje, ett undantag eller ett undantag.
...
1. Klicka på ikonen med tre punkter på fliken **[!UICONTROL Visual content]** för att lägga till en stödlinje, ett undantag eller ett exempel.

1. Ange din riktlinje, exkludering eller exempel.
