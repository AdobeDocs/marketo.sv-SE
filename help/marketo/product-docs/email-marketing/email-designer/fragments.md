...
product: marketo
title: Fragment
description: Lär dig skapa och använda fragment som återanvändbara e-postkomponenter. Lägg till visuella innehållsfragment i e-postmeddelanden och mallar.
...
1. Klicka på ikonen _Teman_ .
   ...
   >[!INFO]
   >
   >Läs mer om [temainställningar](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md#settings){target="_blank"}.
...
>[!NOTE]
>
>Om _Synkronisering med HTML_ är inaktiverat i e-postmeddelandet återspeglas inte ändringar som gjorts (inklusive att bryta arv) i textinnehållet.
