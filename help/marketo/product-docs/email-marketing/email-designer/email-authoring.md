---
description: Lär dig hur du skapar, anpassar och förhandsgranskar e-postmeddelanden i e-postprogrammet Designer. Använd Design Studio eller Email Programs för att skapa e-postmeddelanden.
...
1. Klicka på **Redigera e-postinnehåll** i det e-postmeddelande du just skapade.
...
1. Välj mellan att börja med ett tema (rekommenderas) eller att bygga från början med manuell formatering.

   >[!NOTE]
   >
   >E-postmeddelanden som skapas med manuell formatering kan inte använda fragment som skapats med teman
