...
description: Lär dig hur du inaktiverar spårning för specifika e-postlänkar. Inaktivera klickspårning när det behövs för sekretess eller omdirigerings-URL:er.
