...
description: Läs mer om e-postredigeraren v2.0 och dess funktioner. Skapa och redigera e-postmeddelanden med den modulbaserade redigeraren och mallväljaren.
...
>[!IMPORTANT]
>
>Även om det inte finns något exakt datum kommer den klassiska e-postredigeraren att bli inaktuell (vi kommer att meddela ett exakt datum när vi har ett). Vi rekommenderar att du börjar använda det avancerade [e-postprogrammet Designer](/help/marketo/product-docs/email-marketing/email-designer/overview.md){target="_blank"} eftersom det har många funktioner som inte är tillgängliga i den klassiska redigeraren.
