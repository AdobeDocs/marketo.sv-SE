---
description: Läs mer om standardfältmappningen för Microsoft Dynamics mellan Dynamics och Marketo. Se hur fält för lead, kontakt, konto och affärsmöjlighet mappas automatiskt.
