...
description: Läs om hur användardata synkroniseras från Microsoft Dynamics till Marketo. Förstå vilka ägarfält som synkroniseras och hur de används i smarta listor och flödesåtgärder.
