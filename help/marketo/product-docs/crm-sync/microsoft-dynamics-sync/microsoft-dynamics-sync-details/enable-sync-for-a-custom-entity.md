...
description: Lär dig hur du aktiverar synkronisering för en anpassad enhet i Microsoft Dynamics och Marketo. Använd Admin och Microsoft Dynamics för att välja och aktivera anpassade entiteter för synkronisering.
