...
description: Läs om hur kontaktsynkronisering fungerar mellan Microsoft Dynamics och Marketo. Förstå dubbelriktad synkronisering, skapa kontakter från Marketo och kollisionsregler för data.
