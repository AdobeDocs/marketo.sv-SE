...
description: Lär dig hur du använder Snabbsynkronisering med Microsoft Dynamics när du lägger till ett nytt anpassat fält. Uppdatera fältdata från Dynamics till Marketo när du har lagt till fältet.
