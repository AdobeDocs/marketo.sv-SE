...
1. Logga in på Marketo och klicka **Admin**.
...
1. Ange **[!UICONTROL Username]**, **[!UICONTROL Password]**, Microsoft Dynamics **URL**, **[!UICONTROL Client ID]** och **[!UICONTROL Client Secret]**. Klicka **[!UICONTROL Save]** när det är klart.
