...
description: Läs om hur affärsmöjlighetssynkronisering fungerar från Salesforce till Marketo. Se hur affärsmöjligheter synkroniseras, associeras med kontakter och hur affärsmöjlighetsutlösare och filter används.
