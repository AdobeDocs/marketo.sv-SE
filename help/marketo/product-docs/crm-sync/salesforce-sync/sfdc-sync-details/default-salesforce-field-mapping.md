...
description: Läs mer om standardfältmappningen för Salesforce mellan Salesforce och Marketo Engage. Se hur fält för lead, kontakt, konto och affärsmöjlighet mappas automatiskt.
