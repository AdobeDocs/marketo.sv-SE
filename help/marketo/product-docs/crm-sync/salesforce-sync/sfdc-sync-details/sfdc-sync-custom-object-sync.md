...
description: Lär dig hur du konfigurerar anpassad objektsynkronisering från Salesforce till Marketo. Aktivera anpassade objekt och använd dem i smarta listor, utlösare och kampanjer.
