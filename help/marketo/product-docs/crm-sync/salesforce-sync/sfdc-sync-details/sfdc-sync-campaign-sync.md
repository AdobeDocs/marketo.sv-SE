...
description: Läs om hur du synkroniserar Marketo-program med Salesforce kampanjer. Mappa program till kampanjer och synkronisera medlemmar och status mellan båda systemen.
