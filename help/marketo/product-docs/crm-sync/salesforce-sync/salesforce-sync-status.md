---
description: Lär dig mer om Salesforce Sync Status-instrumentpanelen och hur du visar synkroniseringsstatus. Filtrera efter datum, åtgärdstyp eller objekttyp och exportera synkroniseringsfel som CSV.
