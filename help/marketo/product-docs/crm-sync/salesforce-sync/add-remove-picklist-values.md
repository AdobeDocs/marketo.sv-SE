...
description: Lär dig hur du lägger till och tar bort Salesforce-värden för lista och hur de påverkar Marketo. Lägg till nya värden i formulär från meddelanden och ta bort värden manuellt vid behov.
