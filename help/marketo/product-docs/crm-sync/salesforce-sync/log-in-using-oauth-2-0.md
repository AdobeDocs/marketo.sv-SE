---
description: Lär dig ansluta Marketo och Salesforce med OAuth 2.0. Konfigurera en extern klientapp i Salesforce och auktorisera Marketo att synkronisera säkert utan att dela autentiseringsuppgifter.
