...
1. Klicka på **Gate** och sedan dra och släppa var som helst på arbetsytan.

   ![](assets/image2015-4-27-16-3a54-3a19.png)

1. Redigera **Namn** och välja **Typ**.

   >[!NOTE]
   >
   >Välj [Starta spårning efter konto](/help/marketo/product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models/start-tracking-by-account-in-the-revenue-modeler.md) i nuläget för att få insikt i hur era konton fungerar när de utvecklas i er modell.

   ![](assets/image2015-4-28-12-3a1-3a7.png)

>[!NOTE]
>
>Gate Stage delar upp leads baserat på kriterier som du anger i övergångsreglerna. **det inte håller leads**. En standardövergång krävs så att leads som inte väljs av de andra övergångarna hamnar i standardläget.
...
1. Du kan även ta bort en Gate-scen genom att klicka på den, sedan på **Scenåtgärder** listruta, välja **Ta bort**.
