...
description: Lär dig hur du aktiverar anpassade fältgrupper för modellresultatanalys (leads) i Marketo Engage med hjälp av Aktivera anpassade fält. Slutför nästa steg med den här guiden.
