...
description: Lär dig hur du importerar namngivna konton från en CSV-fil till TAM. Ladda upp listan, välj dedupliceringsläge efter kontonamn eller domän och mappa fält.
