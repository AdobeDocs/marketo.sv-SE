...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   <td><strong>Skicka e-post till Designer - mallimporterare</strong>: Importera e-postmallar från den klassiska e-postredigeraren för att skapa mallar som är kompatibla med den nya e-post-Designer:n i Design Studio.</td>
