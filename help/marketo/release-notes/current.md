...
<table style="table-layout:auto"> 
 ...
 <tr> 
  ...
  <tr> 
   <td><strong>GenStudio-integrering i Designer för e-post</strong>: Integrera GenStudio för prestandamarknadsföring inifrån e-postmeddelanden för att förbättra marknadsföringseffektiviteten och upprätthålla varumärkets enhetlighet.</td> 
   <td><i>Kommer snart</i></td>
   <td><i>Kommer snart</i></td>
  </tr>
 </tbody> 
