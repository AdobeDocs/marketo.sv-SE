---
description: Nya versionsinformation - Marketo Docs - produktdokumentation
title: Nya versionsinformation
hide: true
hidefromtoc: true
...
* **Uppgradera till Google Analytics 4**: RTP-användare har en unik alfanumerisk tagg (finns i `<head>` i HTML-delen) på landningssidorna som gör att Marketo kan skicka data till Google Analytics. Marketo har tidigare använt Universal Analytics, som kommer att sluta spela in data senast den 1 juli 2023. RTP-användare måste följa migreringsprocessen på sin Google Analytics-kontrollpanel för att slutföra migreringen.

* **Uppgradera till jQuery 3.7**: För att öka säkerheten och stabiliteten uppgraderar Marketo till jQuery 3.7.0. RTP-användare som läser in enbart jQuery kan påverkas negativt om de använder en version som är äldre än 3.0.0. Dessa användare kan kontakta Marketo Support för att få hjälp med att implementera en specifik version av rtp.js efter behov. Om du använder version 3.0.0 eller senare kommer du inte att påverkas.
