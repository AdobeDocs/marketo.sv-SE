...
* **Push-aktiviteter från Marketo till Salesforce**: Klicka bara på admin->Salesforce och kontrollera de aktiviteter du vill dela med ditt säljteam.
...
* **Inställningar för** fästig kolumn: När du sorterar eller ändrar ordning på kolumner sparas de inställningarna i Marketo.
