...
Följande funktioner ingår i standardversionscykeln och kommer att släppas den **8 september 2023**, med en stegvis utrullning av återstående funktioner under de följande veckorna. Versionsfunktioner och datum kan komma att ändras. Kontrollera status bredvid varje funktion.
...
<table style="table-layout:auto"> 
 <tbody> 
  ...
  <tr> 
   <td><strong>Marketo Reference Library</strong>: Med Marketo Engage Program Reference Library kan användare importera "example"-program och andra resurser som representerar de bästa metoderna som rekommenderas av Adobe. Vårt produkthanteringsteam har uppdaterat biblioteket helt och hållet, vilket ger mer värdefulla verktyg för dem som vill komma igång snabbt.</td> 
   <td>Levererat</td>
...
<table style="border: 0px">
 <tbody> 
  ...
  <tr> 
   <td><strong>Åtgärdskort i Stream Designer</strong>: Marknadsförare kan använda åtgärdskort i Dialog-strömmen för att skicka dolda värden till Marketo Engage-personposten när besökare interagerar med en dialog.</td> 
   <td>Levererat</td>
   ...
   <tr> 
   <td><strong>Forms för konversationer med Marketo Engage Forms</strong>: Skapa konversation mellan Marketo Engage Forms genom att integrera dem med konversationsflöden i Dynamic Chat. Hitta leads direkt med hjälp av formulärdata eller Smart List-medlemskap för mötesbokningar, rapporter eller anpassade mål.</td> 
   <td>Levererat</td>
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Konversationer i SDK</strong>: Omvandla alla typer av formulär, landningssidor eller nästan alla webbsidor till engagerande mötesbokningsupplevelser.</td> 
   <td>Levererat</td>
  ...
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Marketo Engage Smart List-målgruppsanpassning</strong>: Marknadsförarna kan rikta sig till medlemmar i Marketo Engage Smart Lists i dialogmålgruppskriterier.</td> 
   <td>Levererat</td>
  ...
  <tr> 
   ...
   <tr> 
   <td><strong>Nya aktiviteter på Dynamic Chat</strong>: Nya aktiviteter som stöder konversationsflöden, live chatt och andra nya funktioner.</td> 
   <td>Levererat</td>
  ...
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Konversationsflöde på tillgångssida</strong>: På sidan Design Studio-resurser visas nu konversationsflöden i Dynamic Chat. Se vilka flöden som kan integreras i Marketo Engage och länka direkt till redigeraren.</td> 
   <td>Levererat</td>
   <td>n/a</td>
  </tr>
  <tr> 
   ...
   <td> </td>
    ...
    <tr> 
   <td><strong>Åtgärder för försäljningsinsikter - meddelanden</strong>: Agenter med åtgärder för försäljningsinsikter får meddelanden om direktsända chattförfrågningar i realtid på åtgärdspanelen för försäljningsinsikter.</td> 
...
* **Borttagning av Marketo-händelser och Marketo-stunder**: Adobe kommer att ta bort Marketo Events och Marketo Moments från alla appbutiker från och med 2 oktober 2023. Befintliga användare - du kan fortsätta använda de här apparna tills du migrerar din Marketo Engage-instans till Adobe Identity. De här apparna stöder inte inloggning med Adobe ID.

* **Växla borttagning av växling för Design Studio Assets**: Växlingsväxeln som gör att användare kan växla mellan det klassiska gränssnittet och den moderna UX-upplevelsen för Design Studio kommer att bli inaktuell, tillsammans med den gamla versionen av Design Studio-upplevelsen, vilket gör att användarna kan migrera helt till det moderna användargränssnittet. [Läs mer här](https://nation.marketo.com/t5/the-next-generation-experience/adobe-marketo-engage-switch-to-modern-experience-for-all-design/ba-p/339411){target="_blank"}.
