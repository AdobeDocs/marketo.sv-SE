...
* **Continuous Audience Sync from Adobe Experience Cloud to Marketo Engage**: Target leads med Marketo Engage baserat på förstahandsdata från Adobe Analytics, Adobe Audience Manager eller Adobe Real-Time CDP. Uppdatera automatiskt Marketo Engage statiska listor via kontinuerlig synkronisering, lägg till leads till engagemangs- eller e-postprogram och meddela Försäljning när leads är klara.

## CRM-integrering {#crm-integration}

* **[!DNL Salesforce]CRM-synkronisering**: Identifiera och åtgärda synkroniseringsfel och fel med två nya [!DNL Salesforce] synkroniserings- och felinstrumentpaneler. Övervaka nya postuppdateringar, borttagningar, misslyckanden och slutförande av synkroniseringsprocessen. Rapporterna kan filtreras efter datum, åtgärdstyp eller objekttyp.

* **[!DNL Microsoft Dynamics 365]Integration**: Automatisera registrering av leads och kontakter i [!DNL Microsoft Dynamics 365]-kampanjer. Lägg enkelt till eller ta bort Marketo Engage Leads and Contacts i [!DNL MS Dynamics] kampanjer med nya smarta kampanjflödesåtgärder. Skicka enkelt leads från marknadsföring till försäljning och sluta avtal snabbare.

## Betalda målgruppsinriktade medier {#paid-media-targeting}

* **[!DNL Facebook]Lead Ads Integrations**: [!DNL Facebook] formulärspårningsparametrar kan nu hämtas via LaunchPoint-tjänsten för [!DNL Facebook] lead-annonser. Dessa dolda fält kan nu mappas till Marketo-fält så att marknadsförarna kan lagra och agera på värdefulla kampanjspårningsdata.
