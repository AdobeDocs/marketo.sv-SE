...
* **Integration med Data.com**: Fyll i data med Data.com med en ny Marketo-flödesåtgärd.
...
* **Inbyggt säljprojektsstöd**: Särskilt användbart för kunder som inte använder Salesforce som CRM har vi släppt en uppsättning nya API:er för att utföra åtgärderna Skapa, Läs, Uppdatera och Ta bort (CRUD) på objektet Opportunity i Marketo.
...
* **Förbättrat - analys av affärsmöjlighet**: Affärsmöjlighetsanalysen har uppdaterats med nya filter och möjlighet att skilja mellan händelser som inträffat före, under och efter det att affärsmöjligheten har skapats.
* **Förbättrat - Effektivitetsanalys**: Nu kan du filtrera efter taggar och programkostnader för att anpassa visningen.
* **Detaljgranska rapporter över intäktsutforskaren från Program Effectivity Analyzer**: Om du klickar på en hyperlänk i fönstret med programinformation får du en detaljerad rapport i intäktscykelutforskaren.
* **Förbättrat - intäktscykel - utforskaren**: Vi har förbättrat användargränssnittet flera gånger.
...
* **Programkloning**: Klona programmet/händelsen, inklusive de underordnade kampanjerna och alla lokala resurser som är associerade.
...
* **Arkivera mappar**: Flytta bort oönskade mappar från ditt träd för marknadsföringsaktiviteter genom att konvertera dem till en arkivmapp.
* **Rapport om programprestanda**: Förstå effektiviteten i era marknadsföringsprogram och evenemang med nya mätvärden som nya namn, förvärvade och leads som har nått era definierade kriterier för framgång.

### Analys av intäktscykler {#revenue-cycle-analytics-1}
...
* **Analys av påverkan på affärsmöjlighet**: Mät marknadsföringens bidrag och påverkan. Visa programvärde och andra viktiga möjligheter att skapa engagemang.
...
* **Top 10 Lead Sources**: Den här rapporten visar vilka huvudkällor som har producerat mest leads.
* **Top 10 Lead Sources by Converted Leads**: Den här rapporten visar vilka huvudkällor som har gett störst möjligheter.
* **De 10 främsta leadägarna efter antal affärsmöjligheter vunna**: Den här rapporten visar vilka i organisationen som stänger de flesta möjligheterna.
...
* **Importlista ****Förbättringar**: Välj hur du vill att leadet ska bearbetas vid importen.
...
* **Token i Ändra datavärde**: Använd variabler i ett flödessteg för att ändra datavärde för att uppdatera ett fält.
...
* **Bananalys lyckades**: För kunder som använder Intäktscykel Explorer ska du kontrollera modellens prestanda inifrån Marketo Lead Management.

## November 2010 {#november}

* **Ersätta bilder och filer**: Uppdatera filer som du redan har överfört till Marketo!
* **Webbbesök ****drilldown**: Se vilka webbsidor ett lead visar från webbaktivitetsrapporten.

* **Stöd för kontoägare**: Använd kontoägarens e-posttoken och skicka e-postaviseringar till dem.

## Oktober 2010 {#october}

* **Förbättrad e-postredigerare**: Över 20 buggar har åtgärdats, inklusive sådana som är specifikt inriktade på Chrome.
...
* **Microsites och 301 omdirects**: Total kontroll! Omdirigera en URL till en annan URL med ett enkelt gränssnitt.
...
* **E-postrapport för kampanj**: Skapa anpassade rapporter för att se hur e-postmeddelanden fungerar per kampanj.
* **Radlängd för rapport**: Konfigurera antalet rader som returneras i dina rapporter.
* **Modelleringsfaser**: Använd faser för att se trender i högre ordning när leads rör sig genom modellen.
...
* **E-postklickningsrapport**: Visa information om vilka e-postlänkar som du klickade på.
...
* **Uppdateringar av leadsökning**: Sök snabbare efter leads i snabbvyn.
...
* **Webbaktivitetsrapport för företag**: Se vilka företag som besöker er webbplats mest.
* **Exportera anpassad kolumn**: Exportera leads med markerade kolumner i stället för med alla fält.
