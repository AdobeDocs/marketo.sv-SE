...
* **Kontrollsumma för massextrahera fil**: Kontrollera att en fullständig fil har hämtats genom att jämföra filens hash med kontrollsummesträngen för de slutförda extraheringsjobben.
...
>[!CAUTION]
>
>Från och med 18 juni 2019 är e-post 1.0 inte längre tillgänglig. Du kan läsa mer om e-post 2.0 och borttagningen av e-post 1.0 [här](https://nation.marketo.com/docs/DOC-7038).
...
* **Händelseskiftningar** och **Händelsemål** är vanligtvis tillgängliga i Marketo Sky under tillägget Premium Events.
...
* **Information om bild, fil och kodfragment**: Få snabb information om dina resurser med metadata som _skapad den/av_ och funktionsmakron som _delete_ och _godkänn_.
* **Widget för inlägg i communitybloggar**: Tillgång till nyligen tillagda tjänster från gemenskapen i Min Marketo.
* **Utgår snart Widget**: Lägg till widgeten&quot;Förfallodatum snart&quot; på din Min Marketo-instrumentpanel för att se vilka kampanjer och landningssidor som ska förfalla härnäst.
...
* **Sidan med information om e-postkampanj/utfyllnadstecken**: Se data som vinnande kriterier, skapade på osv. från e-postkampanjen/utmanartesterna.
...
* **Drift Integration**: Förstå hur direkta konversationer påverkar kundens resa. Bizible hämtar även e-postadresser från konversationer för att antingen skapa ett nytt lead eller koppla kontaktytan till ett befintligt lead.
...
***Product Release Webinar*** Se inspelningen av vårt webbseminarium i juni 2019 Release Innovations [här](https://engage.marketo.com/Marketo-June-Product-Release-2019-On-Demand.html).
