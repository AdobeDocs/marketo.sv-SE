...
* **Ursprunglig källinformation i Salesforce**: Uppdatera din Marketo AppExchange-app för nya fält.
...
* **Salesforce-länk i Skicka aviseringsinformation**: När du använder en skicka aviseringsinformation-token i ett e-postmeddelande och leadet finns i Salesforce får du länkar till Salesforce och Marketo.
* **Anpassade Salesforce-kontofält**: Dina anpassade Salesforce-kontofält är nu tillgängliga för användning i Marketo.
...
* **Salesforce-kampanjer**: Nu kan du filtrera och aktivera Salesforce-kampanjer samt lägga in leads i kampanjer baserat på alla kriterier. Använd den som ett vanligt flödessteg.
...
* **Förbättringar av lead-detaljen**: Sidan Lead-detalj har också förbättrats för användbarhet och för att lägga till nya säljprojektsdetaljer från Salesforce. Ta en titt på den nya huvudinformationen och berätta vad du tycker.
