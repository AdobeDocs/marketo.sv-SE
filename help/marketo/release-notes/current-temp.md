---
description: Aktuell versionsinformation Tillfällig - Marketo Docs - Produktdokumentation
title: Aktuell snabbversionsinformation
hide: true
hidefromtoc: true
...
* **Används av räkningskolumn för Design Studio-resurser**: Kolumnen Används av antal för listvyer i Design Studio markerar antalet resurser som används. Detta gäller för kodfragment, e-postmallar, Forms och mallar för landningssidor.
...
* **Växla borttagning av växling för Design Studio-resurser**: Den växlingsväxling som gör att användare kan växla mellan det klassiska gränssnittet och den moderna UX-upplevelsen och Design Studio kommer att bli inaktuella, tillsammans med den gamla versionen av Design Studio-upplevelsen, vilket gör att användare kan migrera helt till den moderna UX-upplevelsen.
