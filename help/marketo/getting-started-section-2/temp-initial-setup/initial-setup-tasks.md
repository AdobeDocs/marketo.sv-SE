...
Efter den här första konfigurationen kan du läsa [Bästa praxis för en ny Marketo Engage-instans](/help/marketo/temp-getting-started-section/temp-best-practice-checklists/where-to-start.md) för att få ut så mycket som möjligt av er investering och göra er redo för långsiktiga framgångar.
