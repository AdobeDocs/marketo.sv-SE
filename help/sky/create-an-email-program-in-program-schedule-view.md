...
1. Du kan nu hitta ditt e-postprogram i kalendern. Håll muspekaren över den för mer information...

   ![Bild fyra](/help/sky/assets/program-schedule-view/create-an-email-program-in-program-schedule-view/create-an-email-program-in-program-schedule-view-4.png)

...eller klicka för att öppna redigeringsfönstret.

![Bild fem](/help/sky/assets/program-schedule-view/create-an-email-program-in-program-schedule-view/create-an-email-program-in-program-schedule-view-5.png)

>[!NOTE]
>
>Du kan skapa e-postprogram i programschemavyn i, [!DNL Marketo Sky]men den faktiska programkonfigurationen kommer att vara i [!DNL Marketo Classic].
