...
>[!TIP]
>
>Du kan även [schemalägga om en batchsmart kampanj i programschemavyn](https://docs.marketo.com/display/DOCS/Reschedule+a+Batch+Smart+Campaign+in+the+Program+Schedule+View).
...
1. Välj **[!UICONTROL Set Run Date/Time]**, klicka sedan på kalenderikonen och välj det datum då du vill att den smarta kampanjen ska köras.
...
1. Välj den tid du vill att den smarta kampanjen ska köras (minst 15 minuter framåt). Klicka utanför kalendern för att stänga den.
